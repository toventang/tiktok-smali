...
public final class a {
    ...
    static List<String> f4912a = Arrays.asList("com.kuaishou.nebula.fileprovider", "com.kwai.videoeditor.kyfileprovider", "com.lemon.lvoverseas.provider", "com.lwcx.lw121.fileprovider", "com.zivn.cloudbrush3.utilcode.provider", "com.tencent.mtt.fileprovider", "com.campmobile.snowcamera.fileprovider", "com.android.fileexplorer.myprovider", "com.ifeimo.videoeditor.provider", "com.mi.android.globalFileexplorer.myprovider");

    /* renamed from: b  reason: collision with root package name */
    static List<String> f4913b = Arrays.asList("com.jk.cutout.application", "com.zone2345.fileprovider", "com.mobile.kadian.fileprovider", "com.miui.securitycenter.zman.fileProvider");
        ...
        if (TextUtils.isEmpty(scheme) || "file".equals(scheme)) {
            ...
            if ("content".equals(scheme)) {
                ...
                if ("com.google.android.apps.photos.contentprovider".equals(uri.getAuthority())) {
                    ...
                    String a4 = a(context, Uri.parse(path2.substring(path2.indexOf("content"), path2.lastIndexOf("/ORIGINAL"))), null, null);
                    MethodCollector.o(4574);
                    return a4;
                }
                if (f4912a.contains(uri.getAuthority())) {
                ...
                } else if (f4913b.contains(uri.getAuthority())) {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:23:0x0045, code lost:
        com.bytedance.frameworks.apm.trace.MethodCollector.o(4577);
     */
    ...
    private static java.lang.String a(android.content.Context r10, android.net.Uri r11, java.lang.String r12, java.lang.String[] r13) {
        ...
        L_0x0045:
            ...
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: c.d.a.a(android.content.Context, android.net.Uri, java.lang.String, java.lang.String[]):java.lang.String");
    }
}
