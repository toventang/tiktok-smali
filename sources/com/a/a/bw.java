...
public final class bw implements e {
    static {
    ...
    public final View a(Context context, ViewGroup viewGroup, boolean z) {
        ...
        viewStub.setId(R.id.eiq);
        viewStub.setInflatedId(R.id.eip);
        viewStub.setLayoutResource(R.layout.a46);
        ...
        if (DrawerLayout.d.class.isInstance(layoutParams7)) {
            ((DrawerLayout.d) layoutParams7).f2691a = 80;
        }
        a.a(view2);
