...
public final class bx implements e {
    static {
    ...
    public final View a(Context context, ViewGroup viewGroup, boolean z) {
        ...
        viewStub2.setId(R.id.cqe);
        viewStub2.setLayoutResource(R.layout.a3v);
        ViewGroup.LayoutParams a9 = a.a(videoSeekBarMaskView, -1, -2);
        if (LinearLayout.LayoutParams.class.isInstance(a9)) {
            ((LinearLayout.LayoutParams) a9).gravity = 80;
        }
        if (FrameLayout.LayoutParams.class.isInstance(a9)) {
            ((FrameLayout.LayoutParams) a9).gravity = 80;
        }
        if (DrawerLayout.d.class.isInstance(a9)) {
            ((DrawerLayout.d) a9).f2691a = 80;
        }
        ...
        ViewGroup.MarginLayoutParams a10 = a.a(videoSeekBarMaskView, -2, -2);
        ...
        if (FrameLayout.LayoutParams.class.isInstance(a10)) {
            ((FrameLayout.LayoutParams) a10).gravity = 81;
        }
        if (DrawerLayout.d.class.isInstance(a10)) {
            ((DrawerLayout.d) a10).f2691a = 81;
        }
        if (ViewGroup.MarginLayoutParams.class.isInstance(a10)) {
            a10.bottomMargin = (int) TypedValue.applyDimension(1, 116.0f, resources.getDisplayMetrics());
        }
        ...
        if (relativeLayout.getParent() == null) {
            videoSeekBarMaskView.addView(relativeLayout, a10);
        }
        ViewStub viewStub3 = new ViewStub(context);
        viewStub3.setId(R.id.a0a);
        viewStub3.setLayoutResource(R.layout.a3w);
        ViewGroup.MarginLayoutParams a11 = android.view.a.a(videoSeekBarMaskView, -2, -2);
        if (LinearLayout.LayoutParams.class.isInstance(a11)) {
            i3 = 81;
            ((LinearLayout.LayoutParams) a11).gravity = 81;
        } else {
            i3 = 81;
        }
        if (FrameLayout.LayoutParams.class.isInstance(a11)) {
            ((FrameLayout.LayoutParams) a11).gravity = i3;
        }
        if (DrawerLayout.d.class.isInstance(a11)) {
            ((DrawerLayout.d) a11).f2691a = i3;
        }
        if (ViewGroup.MarginLayoutParams.class.isInstance(a11)) {
            a11.bottomMargin = (int) TypedValue.applyDimension(1, 44.0f, resources.getDisplayMetrics());
        }
        viewStub3.setInflatedId(-1);
        android.view.a.a(viewStub3);
        if (viewStub3.getParent() == null) {
            videoSeekBarMaskView.addView(viewStub3, a11);
        }
        ViewStub viewStub4 = new ViewStub(context);
        viewStub4.setId(R.id.fl_);
        viewStub4.setVisibility(8);
        viewStub4.setLayoutResource(R.layout.a3i);
        ViewGroup.LayoutParams a12 = android.view.a.a(videoSeekBarMaskView, -1, -2);
        if (LinearLayout.LayoutParams.class.isInstance(a12)) {
            i4 = 80;
            ((LinearLayout.LayoutParams) a12).gravity = 80;
        } else {
            i4 = 80;
        }
        if (FrameLayout.LayoutParams.class.isInstance(a12)) {
            ((FrameLayout.LayoutParams) a12).gravity = i4;
        }
        if (DrawerLayout.d.class.isInstance(a12)) {
            ((DrawerLayout.d) a12).f2691a = i4;
        }
        viewStub4.setInflatedId(-1);
        android.view.a.a(viewStub4);
        if (viewStub4.getParent() == null) {
            videoSeekBarMaskView.addView(viewStub4, a12);
        }
        ...
        ViewGroup.LayoutParams a13 = android.view.a.a(fragmentTabHost, -1, -1);
        android.view.a.a(view2);
        if (view2.getParent() == null) {
            fragmentTabHost.addView(view2, a13);
        }
