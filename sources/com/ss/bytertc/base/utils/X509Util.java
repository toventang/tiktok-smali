...
public class X509Util {
    ...
    /* renamed from: com.ss.bytertc.base.utils.X509Util$1  reason: invalid class name */
    ...
    public static final class TrustStorageListener extends BroadcastReceiver {
        ...
        public final void onReceive(Context context, Intent intent) {
            ...
            try {
                ...
                LogUtil.e("X509Util", "Unable to reload the default TrustManager", e4);
            }
        }
    }
    ...
    public static void clearTestRootCertificates() {
        /*
            r3 = 7813(0x1e85, float:1.0948E-41)
            com.bytedance.frameworks.apm.trace.MethodCollector.i(r3)
            ensureInitialized()
            java.lang.Object r2 = com.ss.bytertc.base.utils.X509Util.sLock
            monitor-enter(r2)
            java.security.KeyStore r1 = com.ss.bytertc.base.utils.X509Util.sTestKeyStore     // Catch:{ IOException -> 0x0014 }
            r0 = 0
        ...
        L_0x0019:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ss.bytertc.base.utils.X509Util.clearTestRootCertificates():void");
    }
    ...
    private static void ensureInitializedLocked() {
        ...
        if (sTrustStorageListener == null) {
            ...
            com_ss_bytertc_base_utils_X509Util_com_ss_android_ugc_aweme_lancet_receiver_ReceiverRegisterLancet_registerReceiver(ContextUtils.getApplicationContext(), sTrustStorageListener, intentFilter);
        }
    }
    ...
    static final class X509TrustManagerIceCreamSandwich implements X509TrustManagerImplementation {
        ...
        public final List<X509Certificate> checkServerTrusted(X509Certificate[] x509CertificateArr, String str, String str2) {
            try {
                ...
                LogUtil.e("X509Util", "X509TrustManager unexpectedly threw: %s", e2);
    ...
    public static final class X509TrustManagerJellyBean implements X509TrustManagerImplementation {
        ...
        public final List<X509Certificate> checkServerTrusted(X509Certificate[] x509CertificateArr, String str, String str2) {
            try {
                ...
                LogUtil.e("X509Util", "checkServerTrusted() unexpectedly threw: %s", e2);
                throw new CertificateException(e2);
            }
        }
    }
    ...
    static boolean verifyKeyUsage(java.security.cert.X509Certificate r5) {
        ...
        L_0x003a:
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ss.bytertc.base.utils.X509Util.verifyKeyUsage(java.security.cert.X509Certificate):boolean");
    }
    ...
    private static X509TrustManagerImplementation createTrustManager(KeyStore keyStore) {
        ...
        try {
            ...
            for (TrustManager trustManager : trustManagers) {
                if (trustManager instanceof X509TrustManager) {
                    try {
                        ...
                        LogUtil.e("X509Util", "Error creating trust manager (" + trustManager.getClass().getName() + "): " + e2);
                    }
                }
            }
            ...
            LogUtil.e("X509Util", "TrustManagerFactory.getTrustManagers() unexpectedly threw: %s", e3);
        ...
        while (true) {
            ...
            if (certificate != null) {
                if (!(certificate instanceof X509Certificate)) {
                    LogUtil.e("X509Util", "Anchor " + str + " not an X509Certificate: " + certificate.getClass().getName());
                } else {
    ...
    public static Intent com_ss_bytertc_base_utils_X509Util_com_bytedance_sysoptimizer_ReceiverRegisterLancet_registerReceiver(Context context, BroadcastReceiver broadcastReceiver, IntentFilter intentFilter) {
        try {
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static android.content.Intent com_ss_bytertc_base_utils_X509Util_com_ss_android_ugc_aweme_lancet_receiver_ReceiverRegisterLancet_registerReceiver(android.content.Context r1, android.content.BroadcastReceiver r2, android.content.IntentFilter r3) {
        /*
            android.app.Application r0 = com.bytedance.ies.ugc.appcontext.g.a()
            com.ss.android.ugc.aweme.lancet.receiver.a.a(r0)
            android.content.Intent r0 = com_ss_bytertc_base_utils_X509Util_com_bytedance_sysoptimizer_ReceiverRegisterLancet_registerReceiver(r1, r2, r3)     // Catch:{ Exception -> 0x000c }
            return r0
        L_0x000c:
        ...
        L_0x0027:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ss.bytertc.base.utils.X509Util.com_ss_bytertc_base_utils_X509Util_com_ss_android_ugc_aweme_lancet_receiver_ReceiverRegisterLancet_registerReceiver(android.content.Context, android.content.BroadcastReceiver, android.content.IntentFilter):android.content.Intent");
    }
            ...
            try {
                ...
                for (int i2 = 1; i2 < bArr.length; i2++) {
                    try {
                        ...
                        LogUtil.w("X509Util", "intermediate " + i2 + " failed parsing");
                    }
                }
                        ...
                        try {
                            ...
                            try {
                                ...
                                try {
                                    ...
                                    LogUtil.i("X509Util", "Failed to validate the certificate chain, error: " + e2.getMessage());
