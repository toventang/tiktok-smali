...
public class LocalDNS extends BaseDNS {
    ...
    public void start() {
        try {
            this.mFuture = TTUploadThreadPool.addExecuteTask(new Runnable() {
                /* class com.ss.ttuploader.net.LocalDNS.AnonymousClass1 */
                ...
                public void run() {
                    TTUploadLog.d("LocalDNS", a.a("----call local dns, host:%s", new Object[]{LocalDNS.this.mHostname}));
                    try {
                        ...
                        if (LocalDNS.this.mAddress == null) {
                            TTUploadLog.d("LocalDNS", a.a("****end call local dns, not get address host:%s", new Object[]{LocalDNS.this.mHostname}));
                        ...
                        if (TextUtils.isEmpty(str)) {
                            TTUploadLog.d("LocalDNS", a.a("****end call local dns, iplist null host:%s", new Object[]{LocalDNS.this.mHostname}));
                            LocalDNS.this.notifyError(new TTUploadDNSInfo(0, LocalDNS.this.mHostname, null, 0, LocalDNS.this.mId));
                            return;
                        }
                        TTUploadLog.d("LocalDNS", a.a("****end call local dns, suc iplist:%s host:%s", new Object[]{str, LocalDNS.this.mHostname}));
                        ...
                        LocalDNS.this.mRet = true;
                        TTUploadLog.d("LocalDNS", a.a("****end call local dns, end exception:%s host:%s", new Object[]{th, LocalDNS.this.mHostname}));
                        LocalDNS.this.notifyError(new TTUploadDNSInfo(0, LocalDNS.this.mHostname, null, 0, LocalDNS.this.mId));
                    }
                }
            });
        } catch (Exception e2) {
            TTUploadLog.d("LocalDNS", a.a("****end call local dns, exception:%s host:%s", new Object[]{e2, this.mHostname}));
    ...
    static class MyRunnable implements Runnable {
        ...
        public void run() {
            TTUploadLog.d("LocalDNS", a.a("----implement delayed check for local dns", new Object[0]));
            LocalDNS localDNS = this.mLocalDNSRef.get();
            if (localDNS == null) {
                TTUploadLog.d("LocalDNS", a.a("****end implement delayed check for local dns, dns object null", new Object[0]));
            } else if (!localDNS.mRet) {
                localDNS.cancel();
                TTUploadLog.d("LocalDNS", a.a("****end implement delayed check cancel local dns,", new Object[0]));
