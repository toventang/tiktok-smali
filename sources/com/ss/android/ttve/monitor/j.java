...
public final class j {
    ...
    private static final Set<String> f61229a;

    /* renamed from: b  reason: collision with root package name */
    private static final Set<String> f61230b;

    /* renamed from: c  reason: collision with root package name */
    private static final Set<String> f61231c;

    /* renamed from: d  reason: collision with root package name */
    private static final Set<String> f61232d;
    ...
    public static int a(String str) {
        if (f61229a.contains(str)) {
            return 1;
        }
        if (f61232d.contains(str)) {
            return 3;
        }
        if (f61230b.contains(str)) {
            return 2;
        }
        return 0;
    }
