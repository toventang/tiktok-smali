...
public final class c extends j implements com.bytedance.jedi.arch.b {
    ...
    public static final a f147812c = new a((byte) 0);

    /* renamed from: a  reason: collision with root package name */
    public RelativeLayout f147813a;

    /* renamed from: b  reason: collision with root package name */
    public RelativeLayout f147814b;

    /* renamed from: d  reason: collision with root package name */
    private final h<Boolean> f147815d;

    /* renamed from: e  reason: collision with root package name */
    private final h<Boolean> f147816e;

    /* renamed from: f  reason: collision with root package name */
    private final h<Boolean> f147817f;
    ...
    public static final /* synthetic */ RelativeLayout a(c cVar) {
        RelativeLayout relativeLayout = cVar.f147814b;
    ...
    public static final /* synthetic */ RelativeLayout b(c cVar) {
        RelativeLayout relativeLayout = cVar.f147813a;
        if (relativeLayout == null) {
            l.a("cornersBottom");
        }
        return relativeLayout;
    ...
    static final class b<T> implements com.bytedance.als.m {
        ...
        public final /* synthetic */ void onChanged(Object obj) {
            ...
            ViewGroup.LayoutParams layoutParams = c.a(this.f147818a).getLayoutParams();
            Objects.requireNonNull(layoutParams, "null cannot be cast to non-null type android.widget.RelativeLayout.LayoutParams");
            RelativeLayout.LayoutParams layoutParams2 = (RelativeLayout.LayoutParams) layoutParams;
            l.b(bool, "");
            if (bool.booleanValue()) {
                i2 = dh.c(this.f147818a.t());
            } else {
                i2 = 0;
            }
            layoutParams2.topMargin = i2;
            c.a(this.f147818a).setLayoutParams(layoutParams2);
        }
    }

    /* renamed from: com.ss.android.ugc.gamora.recorder.i.c$c  reason: collision with other inner class name */
    static final class C3981c<T> implements com.bytedance.als.m {

        /* renamed from: a  reason: collision with root package name */
        final /* synthetic */ c f147819a;
        ...
        public final /* synthetic */ void onChanged(Object obj) {
            int i2;
            Boolean bool = (Boolean) obj;
            ViewGroup.LayoutParams layoutParams = c.b(this.f147819a).getLayoutParams();
            Objects.requireNonNull(layoutParams, "null cannot be cast to non-null type android.widget.RelativeLayout.LayoutParams");
            RelativeLayout.LayoutParams layoutParams2 = (RelativeLayout.LayoutParams) layoutParams;
            l.b(bool, "");
            if (bool.booleanValue()) {
            ...
            c.b(this.f147819a).setLayoutParams(layoutParams2);
        }
    }
    ...
    static final class d<T> implements com.bytedance.als.m {
        ...
        public final /* synthetic */ void onChanged(Object obj) {
            int i2;
            Boolean bool = (Boolean) obj;
            RelativeLayout a2 = c.a(this.f147820a);
            l.b(bool, "");
            int i3 = 0;
            if (bool.booleanValue()) {
                i2 = 0;
            ...
            a2.setVisibility(i2);
            RelativeLayout b2 = c.b(this.f147820a);
            if (!bool.booleanValue()) {
                i3 = 4;
            }
            b2.setVisibility(i3);
    ...
    public final void a(Bundle bundle) {
        ...
        View c2 = c(R.id.afj);
        l.b(c2, "");
        this.f147814b = (RelativeLayout) c2;
        View c3 = c(R.id.afi);
        l.b(c3, "");
        this.f147813a = (RelativeLayout) c3;
        RelativeLayout relativeLayout = this.f147814b;
        if (relativeLayout == null) {
            l.a("cornersTop");
        }
        relativeLayout.setVisibility(0);
        RelativeLayout relativeLayout2 = this.f147813a;
        if (relativeLayout2 == null) {
            l.a("cornersBottom");
        }
        relativeLayout2.setVisibility(0);
        this.f147816e.a(this, new b(this));
        this.f147817f.a(this, new C3981c(this));
        if (eg.a()) {
            RelativeLayout relativeLayout3 = this.f147813a;
            if (relativeLayout3 == null) {
                l.a("cornersBottom");
            }
            relativeLayout3.setVisibility(4);
            RelativeLayout relativeLayout4 = this.f147814b;
        ...
        this.f147815d.a(this, new d(this));
    }
    ...
    public final View a(LayoutInflater layoutInflater, ViewGroup viewGroup) {
        l.d(layoutInflater, "");
        l.d(viewGroup, "");
        View a2 = com.a.a(layoutInflater, R.layout.bix, viewGroup, false);
        l.b(a2, "");
        return a2;
    }
