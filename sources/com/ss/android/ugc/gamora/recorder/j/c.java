...
public final class c extends j implements b, RepeatMusicPlayer.a, g.a {
    ...
    public static final a f147839a = new a((byte) 0);

    /* renamed from: b  reason: collision with root package name */
    private ShortVideoContext f147840b;

    /* renamed from: c  reason: collision with root package name */
    private g f147841c;

    /* renamed from: d  reason: collision with root package name */
    private RepeatMusicPlayer f147842d;

    /* renamed from: e  reason: collision with root package name */
    private String f147843e;

    /* renamed from: f  reason: collision with root package name */
    private int f147844f;

    /* renamed from: g  reason: collision with root package name */
    private int f147845g;

    /* renamed from: h  reason: collision with root package name */
    private final h.f.a.b<Integer, z> f147846h;
    ...
    private final void a() {
        RepeatMusicPlayer repeatMusicPlayer = this.f147842d;
    ...
    public final void e(int i2) {
        this.f147845g = i2;
        this.f147846h.invoke(Integer.valueOf(i2));
        a();
    }
    ...
    public final void a(Bundle bundle) {
        ...
        this.f147840b = shortVideoContext;
        ...
        if (shortVideoContext.f124757b.r != null) {
            ...
            ShortVideoContext shortVideoContext2 = this.f147840b;
            ...
            ShortVideoContext shortVideoContext3 = this.f147840b;
        ...
        this.f147844f = i2;
        ShortVideoContext shortVideoContext4 = this.f147840b;
        if (shortVideoContext4 == null) {
            l.a("shortVideoContext");
        }
        this.f147845g = shortVideoContext4.f124757b.q;
        ShortVideoContext shortVideoContext5 = this.f147840b;
        ...
        ShortVideoContext shortVideoContext6 = this.f147840b;
        if (shortVideoContext6 == null) {
            l.a("shortVideoContext");
        }
        cVar3.f126340a = shortVideoContext6.aw;
        int i3 = this.f147844f;
        ShortVideoContext shortVideoContext7 = this.f147840b;
        if (shortVideoContext7 == null) {
            l.a("shortVideoContext");
        }
        cVar3.a(i3, shortVideoContext7.f124764i, this.f147845g);
        this.f147841c = cVar3;
        a(this.f147845g, this.f147844f);
    }
    ...
    public final View a(LayoutInflater layoutInflater, ViewGroup viewGroup) {
        l.d(layoutInflater, "");
        l.d(viewGroup, "");
        View a2 = com.a.a(layoutInflater, R.layout.biz, viewGroup, false);
        l.b(a2, "");
        return a2;
    }
    ...
    private final void a(int i2, int i3) {
        ...
        if (!TextUtils.isEmpty(str)) {
            if (this.f147842d == null) {
                ...
                String str2 = this.f147843e;
                if (str2 == null) {
                    l.a("mMusicPath");
                }
                this.f147842d = new RepeatMusicPlayer(bVar, str2, i3);
            }
            RepeatMusicPlayer repeatMusicPlayer = this.f147842d;
            if (repeatMusicPlayer == null) {
                l.b();
            ...
            RepeatMusicPlayer repeatMusicPlayer2 = this.f147842d;
