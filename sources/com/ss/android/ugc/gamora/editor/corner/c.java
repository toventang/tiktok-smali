...
public final class c extends j implements com.bytedance.jedi.arch.b {
    ...
    public static final b f145747c = new b((byte) 0);

    /* renamed from: a  reason: collision with root package name */
    public RelativeLayout f145748a;

    /* renamed from: b  reason: collision with root package name */
    public RelativeLayout f145749b;

    /* renamed from: d  reason: collision with root package name */
    private final h f145750d;

    static {
        Covode.recordClassIndex(95741);
    }

    private final EditCornerViewModel a() {
        return (EditCornerViewModel) this.f145750d.getValue();
    }
    ...
    public c() {
        h.k.c a2 = ab.a(EditCornerViewModel.class);
        this.f145750d = h.i.a((h.f.a.a) new a(this, a2, a2));
    }

    public static final class a extends h.f.b.m implements h.f.a.a<EditCornerViewModel> {
        ...
        public final com.ss.android.ugc.gamora.editor.corner.EditCornerViewModel invoke() {
            /*
                r6 = this;
            ...
            L_0x0013:
                ...
                java.lang.Class r0 = h.f.a.a(r0)     // Catch:{ as -> 0x0035 }
                androidx.lifecycle.ac r0 = com_ss_android_ugc_gamora_editor_corner_EditCornerScene$$special$$inlined$hostViewModel$1_androidx_lifecycle_VScopeLancet_get(r2, r1, r0)     // Catch:{ as -> 0x0035 }
            ...
            L_0x003a:
                ...
                java.lang.Class r0 = h.f.a.a(r0)
                androidx.lifecycle.ac r0 = com_ss_android_ugc_gamora_editor_corner_EditCornerScene$$special$$inlined$hostViewModel$1_androidx_lifecycle_VScopeLancet_get(r1, r3, r0)
                com.bytedance.jedi.arch.JediViewModel r0 = (com.bytedance.jedi.arch.JediViewModel) r0
            L_0x0052:
                return r0
            */
            throw new UnsupportedOperationException("Method not decompiled: com.ss.android.ugc.gamora.editor.corner.c.a.invoke():com.bytedance.jedi.arch.JediViewModel");
        }

        public static ac com_ss_android_ugc_gamora_editor_corner_EditCornerScene$$special$$inlined$hostViewModel$1_androidx_lifecycle_VScopeLancet_get(ad adVar, String str, Class cls) {
    ...
    public final void a(Bundle bundle) {
        super.a(bundle);
        this.f145748a = (RelativeLayout) b(R.id.afj);
        this.f145749b = (RelativeLayout) b(R.id.afi);
        a().a(true);
        if (eg.a()) {
            RelativeLayout relativeLayout = this.f145748a;
            if (relativeLayout != null) {
                relativeLayout.setVisibility(4);
            }
            RelativeLayout relativeLayout2 = this.f145749b;
            if (relativeLayout2 != null) {
                relativeLayout2.setVisibility(4);
            }
        } else {
            selectNonNullSubscribe(a(), d.f145751a, new ah(), new C3881c(this));
        }
        selectNonNullSubscribe(a(), e.f145752a, new ah(), new d(this));
        selectNonNullSubscribe(a(), f.f145753a, new ah(), new e(this));
    }
    ...
    public final View a(LayoutInflater layoutInflater, ViewGroup viewGroup) {
        l.d(layoutInflater, "");
        l.d(viewGroup, "");
        View a2 = com.a.a(layoutInflater, R.layout.uz, viewGroup, false);
        l.b(a2, "");
        return a2;
    }

    /* renamed from: com.ss.android.ugc.gamora.editor.corner.c$c  reason: collision with other inner class name */
    static final class C3881c extends h.f.b.m implements h.f.a.m<com.bytedance.jedi.arch.b, Boolean, z> {
        ...
        public final /* synthetic */ z invoke(com.bytedance.jedi.arch.b bVar, Boolean bool) {
            ...
            l.d(bVar, "");
            RelativeLayout relativeLayout = this.this$0.f145748a;
            int i3 = 0;
            if (relativeLayout != null) {
                if (booleanValue) {
                    i2 = 0;
            ...
            RelativeLayout relativeLayout2 = this.this$0.f145749b;
            if (relativeLayout2 != null) {
                if (!booleanValue) {
                    i3 = 4;
                }
    ...
    static final class e extends h.f.b.m implements h.f.a.m<com.bytedance.jedi.arch.b, Integer, z> {
        ...
        public final /* synthetic */ z invoke(com.bytedance.jedi.arch.b bVar, Integer num) {
            int intValue = num.intValue();
            l.d(bVar, "");
            RelativeLayout relativeLayout = this.this$0.f145749b;
            if (relativeLayout != null) {
                ViewGroup.LayoutParams layoutParams = relativeLayout.getLayoutParams();
                Objects.requireNonNull(layoutParams, "null cannot be cast to non-null type android.view.ViewGroup.MarginLayoutParams");
                ViewGroup.MarginLayoutParams marginLayoutParams = (ViewGroup.MarginLayoutParams) layoutParams;
