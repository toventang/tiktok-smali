...
public final class f {
    ...
    public static void a(TuxTextView tuxTextView, ViewGroup.LayoutParams layoutParams) {
        l.d(tuxTextView, "");
        l.d(layoutParams, "");
    }

    public static boolean a(String str, a aVar, TuxTextView tuxTextView, ViewGroup.LayoutParams layoutParams) {
        String str2;
        l.d(str, "");
        l.d(aVar, "");
        l.d(tuxTextView, "");
        l.d(layoutParams, "");
        if (str.hashCode() != -1754121552 || !str.equals("app:tux_font") || (str2 = aVar.f4926a) == null) {
            return false;
        }
