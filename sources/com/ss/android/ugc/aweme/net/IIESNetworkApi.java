...
public interface IIESNetworkApi {
    ...
    @c
    b<String> doDetete(@o int i2, @ag String str, @aa Map<String, String> map, @l List<com.bytedance.retrofit2.client.b> list, @d Object obj);
    ...
    @g
    @u
    b<String> doPut(@o int i2, @ag String str, @aa Map<String, String> map, @f(a = true) Map<String, String> map2, @l List<com.bytedance.retrofit2.client.b> list, @d Object obj);
    ...
    @h
    @ae
    b<TypedInput> downloadFile(@a boolean z, @o int i2, @ag String str, @aa(a = true) Map<String, String> map, @l List<com.bytedance.retrofit2.client.b> list);
    ...
    @t
    @q
    b<String> postMultiPart(@o int i2, @ag String str, @aa(a = true) Map<String, String> map, @w Map<String, TypedOutput> map2, @l List<com.bytedance.retrofit2.client.b> list, @d Object obj);

    @u
    b<String> putBody(@o int i2, @ag String str, @aa(a = true) Map<String, String> map, @com.bytedance.retrofit2.b.b TypedOutput typedOutput, @l List<com.bytedance.retrofit2.client.b> list, @d Object obj);
}
