...
public final class c extends j implements com.bytedance.jedi.arch.b {
    ...
    public static final a f69855d = new a((byte) 0);

    /* renamed from: a  reason: collision with root package name */
    QaStickerView f69856a;

    /* renamed from: b  reason: collision with root package name */
    public final QaStruct f69857b;
    ...
    public final void a(Bundle bundle) {
        ...
        View c2 = c(R.id.dfq);
        l.b(c2, "");
        QaStickerView qaStickerView = (QaStickerView) c2;
        this.f69856a = qaStickerView;
        if (this.f69857b == null) {
        ...
        a(qaStickerView, this.f69857b);
    }

    public c(QaStruct qaStruct, String str) {
        this.f69857b = qaStruct;
        this.f69858c = str;
    }
    ...
    public static final class b implements View.OnTouchListener {
        ...
        /* renamed from: a  reason: collision with root package name */
        final /* synthetic */ c f69859a;

        /* renamed from: b  reason: collision with root package name */
        final /* synthetic */ QaStickerView f69860b;

        static {
            Covode.recordClassIndex(43084);
        }

        b(c cVar, QaStickerView qaStickerView) {
            this.f69859a = cVar;
            this.f69860b = qaStickerView;
        }

        public final boolean onTouch(View view, MotionEvent motionEvent) {
            String c_ = this.f69859a.c_(R.string.de);
            l.b(c_, "");
            new com.bytedance.tux.g.b(this.f69860b).a(c_).b();
            return false;
        }
    }
    ...
    public final View a(LayoutInflater layoutInflater, ViewGroup viewGroup) {
        l.d(layoutInflater, "");
        l.d(viewGroup, "");
        View a2 = com.a.a(layoutInflater, R.layout.aqy, viewGroup, false);
        l.b(a2, "");
        return a2;
    }

    public final void a(QaStickerView qaStickerView, QaStruct qaStruct) {
        l.d(qaStickerView, "");
        l.d(qaStruct, "");
        int c2 = dh.c(qaStickerView.getContext());
        ViewGroup.LayoutParams layoutParams = qaStickerView.getLayoutParams();
        Objects.requireNonNull(layoutParams, "null cannot be cast to non-null type android.view.ViewGroup.MarginLayoutParams");
        ((ViewGroup.MarginLayoutParams) layoutParams).topMargin = ((int) n.b(qaStickerView.getContext(), 130.0f)) + c2;
        qaStickerView.a(qaStruct);
        qaStickerView.setAlpha(false);
        qaStickerView.setOnTouchListener(new b(this, qaStickerView));
        if (TextUtils.equals(this.f69858c, "ask_textual_question")) {
            com.ss.android.ugc.aweme.qasticker.b.a(null, qaStickerView.getContext(), Long.valueOf(qaStruct.getQuestionId()));
        }
    }
