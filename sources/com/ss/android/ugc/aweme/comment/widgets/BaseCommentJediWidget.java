...
public abstract class BaseCommentJediWidget extends Widget implements q, au {
    static {
    ...
    protected static final class a<T extends View> {
        ...
        public final T a(BaseCommentJediWidget baseCommentJediWidget, h.k.i<?> iVar) {
            l.d(baseCommentJediWidget, "");
            l.d(iVar, "");
            if (this.f73045a == null) {
                View view = baseCommentJediWidget.f46127e;
                if (view == null) {
                    l.b();
                }
                T t = (T) view.findViewById(this.f73046b);
                if (t == null) {
                    l.b();
                }
                this.f73045a = t;
