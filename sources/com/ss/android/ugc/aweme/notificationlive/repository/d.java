...
public final class d extends com.bytedance.jedi.a.j.b {

    /* renamed from: b  reason: collision with root package name */
    private final b f114370b;

    /* renamed from: c  reason: collision with root package name */
    private final c f114371c;

    /* renamed from: d  reason: collision with root package name */
    private final com.bytedance.jedi.a.a.c<String, User> f114372d;
    ...
    public static final class a extends m implements h.f.a.b<a.c<a, List<? extends User>, z, List<? extends User>>, z> {
        ...
        public final void invoke(a.c<a, List<User>, z, List<User>> cVar) {
            ...
            cVar.a(new h.f.a.m<a, List<? extends User>, z>(this) {
                /* class com.ss.android.ugc.aweme.notificationlive.repository.d.a.AnonymousClass1 */
            ...
            cVar.a(new q<a, List<? extends User>, List<? extends User>, List<? extends User>>(this) {
                /* class com.ss.android.ugc.aweme.notificationlive.repository.d.a.AnonymousClass2 */
                final /* synthetic */ a this$0;
    ...
    public static final class b extends m implements h.f.a.b<a.d<? extends Object, User, ? extends Object, List<? extends User>>, z> {
        static {
        ...
        public final void invoke(a.d<? extends Object, User, ? extends Object, List<User>> dVar) {
            ...
            dVar.b(new h.f.a.m<User, List<? extends User>, List<? extends User>>(this) {
                /* class com.ss.android.ugc.aweme.notificationlive.repository.d.b.AnonymousClass2 */
    ...
    public static final class c extends m implements h.f.a.b<a.C0951a<? extends Object, List<? extends User>, String, User>, z> {
        ...
        public final void invoke(a.C0951a<? extends Object, List<User>, String, User> aVar) {
            ...
            aVar.a(new h.f.a.b<List<? extends User>, List<? extends p<? extends String, ? extends User>>>(this) {
                /* class com.ss.android.ugc.aweme.notificationlive.repository.d.c.AnonymousClass1 */
    ...
    public final t<com.ss.android.ugc.aweme.following.a.c> a(String str, String str2, long j2, int i2, int i3, int i4, int i5) {
        l.d(str, "");
        l.d(str2, "");
        return this.f114370b.c(new a(str, str2, j2, i2, 3, i3, i4, i5));
    }
}
