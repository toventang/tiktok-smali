...
public class q extends n.a {
    ...
    public final l f125517a;

    /* renamed from: b  reason: collision with root package name */
    private boolean f125518b;

    /* renamed from: c  reason: collision with root package name */
    private boolean f125519c;
    ...
    public final void d(RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder) {
        l.d(recyclerView, "");
        l.d(viewHolder, "");
        this.f125517a.a(viewHolder, this.f125518b);
    ...
    public boolean b(RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder, RecyclerView.ViewHolder viewHolder2) {
        ...
        l.d(viewHolder2, "");
        m.a(i.f115645a, 50);
        this.f125517a.a(viewHolder, viewHolder2);
        this.f125518b = true;
        return true;
    }
    ...
    public final void a(Canvas canvas, RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder, float f2, float f3, int i2, boolean z) {
        ...
        if (i2 != 2 || z) {
            ...
            this.f125519c = true;
        } else if (this.f125519c) {
            this.f125519c = false;
            this.f125517a.b(viewHolder).translationX(0.0f).translationY(0.0f).setDuration(a(recyclerView, 8)).start();
        }
    }
}
