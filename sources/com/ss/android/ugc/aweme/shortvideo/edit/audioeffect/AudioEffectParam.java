...
public final class AudioEffectParam implements Parcelable, IAudioEffectParam, Serializable {
    ...
    public static final class a implements Parcelable.Creator<AudioEffectParam> {
        ...
        public final /* bridge */ /* synthetic */ AudioEffectParam[] newArray(int i2) {
    ...
    public AudioEffectParam(String str, int i2, int i3, String str2, String str3, int i4, int i5, byte[] bArr, AVChallenge aVChallenge) {
        l.d(str, "");
        l.d(str2, "");
        l.d(str3, "");
        this.uploadId = str;
    ...
    /* JADX WARNING: Illegal instructions before constructor call */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public /* synthetic */ AudioEffectParam(java.lang.String r12, int r13, int r14, java.lang.String r15, java.lang.String r16, int r17, int r18, byte[] r19, com.ss.android.ugc.aweme.shortvideo.AVChallenge r20, int r21, h.f.b.g r22) {
        /*
            r11 = this;
            r1 = r21
            r7 = r17
        ...
        L_0x0043:
            ...
            goto L_0x0025
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ss.android.ugc.aweme.shortvideo.edit.audioeffect.AudioEffectParam.<init>(java.lang.String, int, int, java.lang.String, java.lang.String, int, int, byte[], com.ss.android.ugc.aweme.shortvideo.AVChallenge, int, h.f.b.g):void");
    }
}
