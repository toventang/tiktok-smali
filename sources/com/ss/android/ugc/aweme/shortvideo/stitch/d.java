...
public final class d extends com.ss.android.ugc.gamora.b.b implements com.bytedance.jedi.arch.b {
    ...
    public static final a f130816c = new a((byte) 0);
    ...
    private CutVideoBottomBarViewModel f130819d;
    ...
    public final void a(Bundle bundle) {
        ...
        JediViewModel a2 = t.a((e) activity).a(CutVideoBottomBarViewModel.class);
        l.b(a2, "");
        CutVideoBottomBarViewModel cutVideoBottomBarViewModel = (CutVideoBottomBarViewModel) a2;
        this.f130819d = cutVideoBottomBarViewModel;
        if (cutVideoBottomBarViewModel == null) {
            l.a("viewModel");
        }
        selectNonNullSubscribe(cutVideoBottomBarViewModel, e.f130820a, new ah(), new b(this));
    }
    ...
    public final View a(LayoutInflater layoutInflater, ViewGroup viewGroup) {
        l.d(layoutInflater, "");
        l.d(viewGroup, "");
        View a2 = com.a.a(layoutInflater, R.layout.auh, viewGroup, false);
        l.b(a2, "");
        return a2;
    }

    static final class b extends h.f.b.m implements h.f.a.m<com.bytedance.jedi.arch.b, Float, z> {
        ...
        public final /* synthetic */ z invoke(com.bytedance.jedi.arch.b bVar, Float f2) {
            ...
            l.d(bVar, "");
            d dVar = this.this$0;
            TextView textView = dVar.f130818b;
            if (textView == null) {
                l.a("tvTime");
            }
            Activity t = dVar.t();
            l.b(t, "");
            bs bsVar = dVar.f130817a;
            if (bsVar == null) {
