...
public final class MonitorSizeChangedLinearLayout extends LinearLayout {
    ...
    private r<? super Integer, ? super Integer, ? super Integer, ? super Integer, z> f70247a;
    ...
    public final void onSizeChanged(int i2, int i3, int i4, int i5) {
        ...
        r<? super Integer, ? super Integer, ? super Integer, ? super Integer, z> rVar = this.f70247a;
        if (rVar != null) {
