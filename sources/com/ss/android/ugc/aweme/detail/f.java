...
public final class f extends b {
    ...
    static final class a extends m implements h.f.a.b<cf, ce> {
        ...
        public final /* synthetic */ ce invoke(cf cfVar) {
            cf cfVar2 = cfVar;
            l.d(cfVar2, "");
            return new DetailFeedVideoViewHolder(cfVar2);
        }
    }

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public f(Context context, LayoutInflater layoutInflater, s<ag> sVar, Fragment fragment, View.OnTouchListener onTouchListener, BaseFeedPageParams baseFeedPageParams, com.ss.android.ugc.aweme.feed.e.l lVar) {
