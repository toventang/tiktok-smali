...
public final class c extends a {
    ...
    private final boolean f135680c;

    /* renamed from: d  reason: collision with root package name */
    private final com.ss.android.ugc.aweme.sticker.senor.a f135681d;
    ...
    public final void onSensorChanged(SensorEvent sensorEvent) {
        ...
        if (this.f135676a) {
            this.f135681d.b((double) sensorEvent.values[0], (double) sensorEvent.values[1], (double) sensorEvent.values[2], a2);
        }
    }
