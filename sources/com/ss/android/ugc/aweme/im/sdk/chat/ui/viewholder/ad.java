...
public class ad extends a<ShareCompilationContent> {
    private RemoteImageView A;

    /* renamed from: a  reason: collision with root package name */
    private RemoteImageView f101331a;

    /* renamed from: b  reason: collision with root package name */
    private TuxTextView f101332b;
    ...
    public void a() {
        ...
        l.b(a3, "");
        this.f101331a = (RemoteImageView) a3;
        Object a4 = a(R.id.title_tv);
        l.b(a4, "");
        this.f101332b = (TuxTextView) a4;
    ...
    public ad(View view, com.ss.android.ugc.aweme.im.sdk.chat.data.e.b bVar) {
        super(view);
        l.d(view, "");
        l.d(bVar, "");
    }
    ...
    public void a(ai aiVar, ai aiVar2, ShareCompilationContent shareCompilationContent, int i2) {
        ...
        if (shareCompilationContent != null) {
            ...
            TuxTextView tuxTextView = this.f101332b;
            if (tuxTextView == null) {
                l.a("titleView");
            }
            ...
            tuxTextView2.setText(resources.getString(R.string.as2, objArr));
            ...
            RemoteImageView remoteImageView4 = this.f101331a;
            if (remoteImageView4 == null) {
                l.a("iconView");
            }
            e.a(remoteImageView4, 2131232857);
        }
