...
public final class SelectedListCell extends PowerCell<b> {
    ...
    final com.bytedance.assem.arch.viewModel.b f102759a;
    ...
    public final void k() {
        ...
        h.f.b.l.b(view, "");
        ((CircleImageView) view.findViewById(R.id.a7y)).setOnClickListener(oVar);
        View view2 = this.itemView;
        h.f.b.l.b(view2, "");
        ((AvatarImageView) view2.findViewById(R.id.p4)).setOnClickListener(oVar);
    }
    ...
    static final class o implements View.OnClickListener {
        ...
        /* renamed from: a  reason: collision with root package name */
        final /* synthetic */ SelectedListCell f102760a;
        ...
        o(SelectedListCell selectedListCell) {
            this.f102760a = selectedListCell;
        }

        public final void onClick(View view) {
            ClickAgent.onClick(view);
            b bVar = (b) this.f102760a.f34234d;
            if (bVar != null) {
                ((ContactListViewModel) this.f102760a.f102759a.getValue()).a(bVar.f102762a, false);
            }
        }
    }
    ...
    public final View a(ViewGroup viewGroup) {
        h.f.b.l.d(viewGroup, "");
        View a2 = com.a.a(LayoutInflater.from(viewGroup.getContext()), R.layout.a53, viewGroup, false);
        h.f.b.l.b(a2, "");
        return a2;
    }
    ...
    public final /* synthetic */ void a(b bVar) {
        ...
        h.f.b.l.d(bVar2, "");
        View view = this.itemView;
        com.ss.android.ugc.aweme.base.e.a((RemoteImageView) view.findViewById(R.id.p4), bVar2.f102762a.getDisplayAvatar());
        View findViewById = view.findViewById(R.id.csg);
        h.f.b.l.b(findViewById, "");
        ((TextView) findViewById).setText(bVar2.f102762a.getDisplayName());
    }
}
