...
public final class SugToWhoShareLinkViewModel extends BasePrivacyUserSettingViewModel implements j {
    static {
    ...
    public final t<BaseResponse> b(int i2) {
        return a.c("to_who_share_link", i2);
    }
    ...
    public final Integer a(q qVar) {
        ...
        if (tVar != null) {
            return Integer.valueOf(tVar.f76698d);
        }
        return null;
    }
