...
public final class SugToInterestedUsersViewModel extends BasePrivacyUserSettingViewModel implements j {
    static {
    ...
    public final t<BaseResponse> b(int i2) {
        return a.c("to_interested_users", i2);
    }
    ...
    public final Integer a(q qVar) {
        ...
        if (tVar != null) {
            return Integer.valueOf(tVar.f76699e);
        }
        return null;
    }
