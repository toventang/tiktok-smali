...
public final class MentionViewModel extends BasePrivacyUserSettingViewModel implements j {
    static {
    ...
    public final Integer a(q qVar) {
        ...
        f fVar = qVar.f76690f;
        if (fVar != null) {
            return Integer.valueOf(fVar.f76658a);
        }
        return null;
    }
    ...
    public final void a(int i2, BaseResponse baseResponse) {
        ...
        r.a("change_mention_permission", new d().a("enter_from", "privacy_and_safety_settings").a("to_status", b.c.a(i2)).f66730a);
    }
}
