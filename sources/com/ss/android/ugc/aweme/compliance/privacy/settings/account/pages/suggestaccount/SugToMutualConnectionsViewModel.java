...
public final class SugToMutualConnectionsViewModel extends BasePrivacyUserSettingViewModel implements j {
    static {
    ...
    public final t<BaseResponse> b(int i2) {
        return a.c("to_mutual_connections", i2);
    }
    ...
    public final Integer a(q qVar) {
        ...
        if (tVar != null) {
            return Integer.valueOf(tVar.f76697c);
        }
        return null;
    }
