...
public final class SugToFbFriendsViewModel extends BasePrivacyUserSettingViewModel implements j {
    static {
    ...
    public final Integer a(q qVar) {
        ...
        if (tVar != null) {
            return Integer.valueOf(tVar.f76696b);
        }
        return null;
    }
