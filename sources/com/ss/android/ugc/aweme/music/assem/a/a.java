...
public abstract class a extends com.bytedance.assem.arch.d.a implements b<Object> {
    ...
    private volatile c f111122j;

    /* renamed from: k  reason: collision with root package name */
    private final Object f111123k = new Object();
    ...
    private c u() {
        if (this.f111122j == null) {
            synchronized (this.f111123k) {
                if (this.f111122j == null) {
                    this.f111122j = new c(this);
                }
            }
        }
        return this.f111122j;
    }
}
