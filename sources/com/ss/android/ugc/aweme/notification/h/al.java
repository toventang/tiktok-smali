...
public final class al extends p implements View.OnClickListener {
    ...
    private final View f113537a;

    /* renamed from: b  reason: collision with root package name */
    private final AvatarImageWithVerify f113538b;

    /* renamed from: c  reason: collision with root package name */
    private final TextView f113539c;

    /* renamed from: d  reason: collision with root package name */
    private final TextView f113540d;

    /* renamed from: e  reason: collision with root package name */
    private final RemoteImageView f113541e;

    /* renamed from: f  reason: collision with root package name */
    private PostNotice f113542f;
    ...
    static final class a extends m implements h.f.a.a<z> {
        ...
        public final /* synthetic */ z invoke() {
            ...
            l.b(str, "");
            e.a("create_aweme", i2, str, this.this$0.f113487h.a(), this.this$0.f113648j.templateId);
            return z.f158842a;
        }
    }
    ...
    public final void a(com.ss.android.ugc.aweme.notice.repo.list.bean.MusNotice r8) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ss.android.ugc.aweme.notification.h.al.a(com.ss.android.ugc.aweme.notice.repo.list.bean.MusNotice):void");
    }
    ...
    public final void onClick(View view) {
        ...
        PostNotice postNotice = this.f113542f;
        if (postNotice != null && (aweme = postNotice.getAweme()) != null) {
            ...
            if (num != null) {
                if (num.intValue() == R.id.cx6) {
                    ...
                    t.a(t.a(), u.a("aweme://aweme/detail/" + aweme.getAid()).a("refer", "message").a());
                    ...
                    if (!TextUtils.isEmpty(aid)) {
                        ...
                        l.b(author4, "");
                        c a2 = cVar.a("request_id", author4.getRequestId());
                        if (aweme.getAllowGift()) {
                            str = "1";
                        } else {
                            str = "0";
                        }
                        r.onEvent(value.setJsonObject(a2.a("is_giftable", str).a()));
                    }
                }
            }
        }
