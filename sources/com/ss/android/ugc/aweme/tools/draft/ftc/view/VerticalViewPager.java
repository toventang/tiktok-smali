...
public class VerticalViewPager extends com.ss.android.ugc.aweme.common.widget.c {
    ...
    public static final int[] f139718a = {16842931};
    private static final h ak = new h();

    /* renamed from: b  reason: collision with root package name */
    public static final Interpolator f139719b = new Interpolator() {
        /* class com.ss.android.ugc.aweme.tools.draft.ftc.view.VerticalViewPager.AnonymousClass2 */
    ...
    static Field f139720e;

    /* renamed from: h  reason: collision with root package name */
    private static final Comparator<c> f139721h = new Comparator<c>() {
        /* class com.ss.android.ugc.aweme.tools.draft.ftc.view.VerticalViewPager.AnonymousClass1 */
        ...
        public final /* bridge */ /* synthetic */ int compare(c cVar, c cVar2) {
            return cVar.f139738b - cVar2.f139738b;
        }
    };
    private boolean A;
    private boolean B;
    ...
    private final Runnable al = new Runnable() {
        /* class com.ss.android.ugc.aweme.tools.draft.ftc.view.VerticalViewPager.AnonymousClass3 */
    ...
    public PagerAdapter f139722c;

    /* renamed from: d  reason: collision with root package name */
    public int f139723d;

    /* renamed from: f  reason: collision with root package name */
    private boolean f139724f = true;

    /* renamed from: g  reason: collision with root package name */
    private int f139725g;

    /* renamed from: i  reason: collision with root package name */
    private final ArrayList<c> f139726i = new ArrayList<>();

    /* renamed from: j  reason: collision with root package name */
    private final c f139727j = new c();

    /* renamed from: k  reason: collision with root package name */
    private final Rect f139728k = new Rect();

    /* renamed from: l  reason: collision with root package name */
    private int f139729l = -1;

    /* renamed from: m  reason: collision with root package name */
    private Parcelable f139730m = null;
    ...
    public static class h implements Comparator<View> {
        ...
        public final /* synthetic */ int compare(View view, View view2) {
            ...
            if (dVar.f139742a == dVar2.f139742a) {
                return dVar.f139746e - dVar2.f139746e;
            }
            if (dVar.f139742a) {
                return 1;
            }
    ...
    public int getCurrentItem() {
        return this.f139723d;
    }

    public int getExpectedAdapterCount() {
        return this.f139725g;
    }
    ...
    private void a(int i2, boolean z2, boolean z3, int i3) {
        PagerAdapter pagerAdapter = this.f139722c;
        boolean z4 = false;
        if (pagerAdapter == null || pagerAdapter.getCount() <= 0) {
            setScrollingCacheEnabled(false);
        } else if (z3 || this.f139723d != i2 || this.f139726i.size() == 0) {
            if (i2 < 0) {
                i2 = 0;
            } else if (i2 >= this.f139722c.getCount()) {
                i2 = this.f139722c.getCount() - 1;
            }
            int i4 = this.C;
            int i5 = this.f139723d;
            if (i2 > i5 + i4 || i2 < i5 - i4) {
                for (int i6 = 0; i6 < this.f139726i.size(); i6++) {
                    this.f139726i.get(i6).f139739c = true;
                }
            }
            if (this.f139723d != i2) {
                z4 = true;
    ...
    private void a(int i2, boolean z2, int i3, boolean z3) {
        c b2 = b(i2);
        int clientHeight = b2 != null ? (int) (((float) getClientHeight()) * Math.max(this.v, Math.min(b2.f139741e, this.w))) : 0;
        if (z2) {
            a(clientHeight, i3);
            if (z3) {
                List<ViewPager.e> list = this.ad;
    ...
    private void a(c cVar, int i2, c cVar2) {
        c cVar3;
        c cVar4;
        int count = this.f139722c.getCount();
        int clientHeight = getClientHeight();
        float f2 = clientHeight > 0 ? ((float) this.r) / ((float) clientHeight) : 0.0f;
        if (cVar2 != null) {
            int i3 = cVar2.f139738b;
            if (i3 < cVar.f139738b) {
                float f3 = cVar2.f139741e + cVar2.f139740d + f2;
                int i4 = i3 + 1;
                int i5 = 0;
                while (i4 <= cVar.f139738b && i5 < this.f139726i.size()) {
                    c cVar5 = this.f139726i.get(i5);
                    while (true) {
                        cVar4 = cVar5;
                        if (i4 > cVar4.f139738b && i5 < this.f139726i.size() - 1) {
                            i5++;
                            cVar5 = this.f139726i.get(i5);
                        }
                    }
                    while (i4 < cVar4.f139738b) {
                        f3 += this.f139722c.getPageWidth(i4) + f2;
                        i4++;
                    }
                    cVar4.f139741e = f3;
                    f3 += cVar4.f139740d + f2;
                    i4++;
                }
            } else if (i3 > cVar.f139738b) {
                int size = this.f139726i.size() - 1;
                float f4 = cVar2.f139741e;
                int i6 = i3 - 1;
                while (i6 >= cVar.f139738b && size >= 0) {
                    c cVar6 = this.f139726i.get(size);
                    while (true) {
                        cVar3 = cVar6;
                        if (i6 < cVar3.f139738b && size > 0) {
                            size--;
                            cVar6 = this.f139726i.get(size);
                        }
                    }
                    while (i6 > cVar3.f139738b) {
                        f4 -= this.f139722c.getPageWidth(i6) + f2;
                        i6--;
                    }
                    f4 -= cVar3.f139740d + f2;
                    cVar3.f139741e = f4;
                    i6--;
                }
            }
        }
        int size2 = this.f139726i.size();
        float f5 = cVar.f139741e;
        int i7 = cVar.f139738b - 1;
        this.v = cVar.f139738b == 0 ? cVar.f139741e : -3.4028235E38f;
        int i8 = count - 1;
        this.w = cVar.f139738b == i8 ? (cVar.f139741e + cVar.f139740d) - 1.0f : Float.MAX_VALUE;
        int i9 = i2 - 1;
        while (i9 >= 0) {
            c cVar7 = this.f139726i.get(i9);
            while (i7 > cVar7.f139738b) {
                f5 -= this.f139722c.getPageWidth(i7) + f2;
                i7--;
            }
            f5 -= cVar7.f139740d + f2;
            cVar7.f139741e = f5;
            if (cVar7.f139738b == 0) {
                this.v = f5;
            }
        ...
        float f6 = cVar.f139741e + cVar.f139740d + f2;
        int i10 = cVar.f139738b + 1;
        int i11 = i2 + 1;
        while (i11 < size2) {
            c cVar8 = this.f139726i.get(i11);
            while (i10 < cVar8.f139738b) {
                f6 += this.f139722c.getPageWidth(i10) + f2;
                i10++;
            }
            if (cVar8.f139738b == i8) {
                this.w = (cVar8.f139740d + f6) - 1.0f;
            }
            cVar8.f139741e = f6;
            f6 += cVar8.f139740d + f2;
            i11++;
            i10++;
        }
        this.aa = false;
    ...
    private void a(int i2, int i3, int i4, int i5) {
        if (i3 <= 0 || this.f139726i.isEmpty()) {
            c b2 = b(this.f139723d);
            int min = (int) ((b2 != null ? Math.min(b2.f139741e, this.w) : 0.0f) * ((float) ((i2 - getPaddingTop()) - getPaddingBottom())));
            if (min != getScrollY()) {
                a(false);
    ...
    private void a(boolean z2) {
        ...
        this.B = false;
        for (int i2 = 0; i2 < this.f139726i.size(); i2++) {
            c cVar = this.f139726i.get(i2);
            if (cVar.f139739c) {
                cVar.f139739c = false;
                z3 = true;
            }
    ...
    public final void a(float f2) {
        if (!this.S) {
            ...
            try {
                ...
                c cVar = this.f139726i.get(0);
                ArrayList<c> arrayList = this.f139726i;
                c cVar2 = arrayList.get(arrayList.size() - 1);
                if (cVar.f139738b != 0) {
                    f3 = cVar.f139741e * clientHeight;
                }
                if (cVar2.f139738b != this.f139722c.getCount() - 1) {
                    f4 = cVar2.f139741e * clientHeight;
                }
                if (scrollY < f3) {
                    scrollY = f3;
                } else if (scrollY > f4) {
    ...
    public static class d extends ViewGroup.LayoutParams {
        ...
        public d(Context context, AttributeSet attributeSet) {
            ...
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, VerticalViewPager.f139718a);
            this.f139743b = obtainStyledAttributes.getInteger(0, 48);
    ...
    public static class SavedState extends View.BaseSavedState {
        public static final Parcelable.Creator<SavedState> CREATOR = androidx.core.d.e.a(new androidx.core.d.f<SavedState>() {
            /* class com.ss.android.ugc.aweme.tools.draft.ftc.view.VerticalViewPager.SavedState.AnonymousClass1 */
        ...
        public String toString() {
            return "FragmentPager.SavedState{" + Integer.toHexString(System.identityHashCode(this)) + " position=" + this.f139734a + "}";
        }
        ...
        public void writeToParcel(Parcel parcel, int i2) {
            ...
            parcel.writeInt(this.f139734a);
            parcel.writeParcelable(this.f139735b, i2);
        }

        SavedState(Parcel parcel, ClassLoader classLoader) {
            super(parcel);
            classLoader = classLoader == null ? getClass().getClassLoader() : classLoader;
            this.f139734a = parcel.readInt();
            this.f139735b = parcel.readParcelable(classLoader);
            this.f139736c = classLoader;
        }
    }
    ...
    class e extends androidx.core.h.a {
        ...
        private boolean a() {
            if (VerticalViewPager.this.f139722c == null || VerticalViewPager.this.f139722c.getCount() <= 1) {
                return false;
            }
            return true;
        }
        ...
        public final void d(View view, AccessibilityEvent accessibilityEvent) {
            ...
            a2.a(a());
            if (accessibilityEvent.getEventType() == 4096 && VerticalViewPager.this.f139722c != null) {
                a2.a(VerticalViewPager.this.f139722c.getCount());
                a2.b(VerticalViewPager.this.f139723d);
                a2.c(VerticalViewPager.this.f139723d);
            }
        }
        ...
        public final boolean a(View view, int i2, Bundle bundle) {
            ...
            if (i2 != 4096) {
                ...
                verticalViewPager.setCurrentItem(verticalViewPager.f139723d - 1);
                return true;
            } else if (!VerticalViewPager.this.canScrollVertically(1)) {
                return false;
            } else {
                VerticalViewPager verticalViewPager2 = VerticalViewPager.this;
                verticalViewPager2.setCurrentItem(verticalViewPager2.f139723d + 1);
                return true;
            }
        }
    }
    ...
    private boolean m() {
        PagerAdapter pagerAdapter = this.f139722c;
        if (pagerAdapter == null || this.f139723d >= pagerAdapter.getCount() - 1) {
            return false;
        }
        a(this.f139723d + 1, true);
        return true;
    }
    ...
    public Parcelable onSaveInstanceState() {
        ...
        savedState.f139734a = this.f139723d;
        PagerAdapter pagerAdapter = this.f139722c;
        if (pagerAdapter != null) {
            savedState.f139735b = pagerAdapter.saveState();
        }
        return savedState;
    }
    ...
    private c j() {
        ...
        int i4 = 0;
        boolean z2 = true;
        while (i4 < this.f139726i.size()) {
            c cVar2 = this.f139726i.get(i4);
            if (!z2 && cVar2.f139738b != (i2 = i3 + 1)) {
                cVar2 = this.f139727j;
                cVar2.f139741e = f4 + f5 + f3;
                cVar2.f139738b = i2;
                cVar2.f139740d = this.f139722c.getPageWidth(cVar2.f139738b);
                i4--;
            }
            f4 = cVar2.f139741e;
            float f6 = cVar2.f139740d + f4 + f3;
            if (!z2 && f2 < f4) {
                return cVar;
            }
            if (f2 < f6 || i4 == this.f139726i.size() - 1) {
                return cVar2;
            }
            i3 = cVar2.f139738b;
            f5 = cVar2.f139740d;
    ...
    public final void d() {
        if (this.S) {
            if (this.f139722c != null) {
                ...
                int scrollY = getScrollY();
                c j2 = j();
                a(a(j2.f139738b, ((((float) scrollY) / ((float) clientHeight)) - j2.f139741e) / j2.f139740d, yVelocity, (int) (this.J - this.L)), true, true, yVelocity);
            }
            k();
            this.S = false;
            return;
    ...
    public final void e() {
        ...
        int count = this.f139722c.getCount();
        this.f139725g = count;
        if (this.f139726i.size() >= (this.C * 2) + 1 || this.f139726i.size() >= count) {
            z2 = false;
        } else {
            z2 = true;
        }
        ...
        int i3 = 0;
        boolean z3 = false;
        while (i3 < this.f139726i.size()) {
            c cVar = this.f139726i.get(i3);
            int itemPosition = this.f139722c.getItemPosition(cVar.f139737a);
            if (itemPosition != -1) {
                if (itemPosition == -2) {
                    this.f139726i.remove(i3);
                    i3--;
                    if (!z3) {
                        this.f139722c.startUpdate((ViewGroup) this);
                        z3 = true;
                    }
                    this.f139722c.destroyItem((ViewGroup) this, cVar.f139738b, cVar.f139737a);
                    if (this.f139723d == cVar.f139738b) {
                        i2 = Math.max(0, Math.min(this.f139723d, count - 1));
                    }
                } else if (cVar.f139738b != itemPosition) {
                    if (cVar.f139738b == this.f139723d) {
                        i2 = itemPosition;
                    }
                    cVar.f139738b = itemPosition;
                }
                z2 = true;
            }
            i3++;
        ...
        if (z3) {
            this.f139722c.finishUpdate((ViewGroup) this);
        }
        Collections.sort(this.f139726i, f139721h);
        if (z2) {
            int childCount = getChildCount();
    ...
    public boolean dispatchTouchEvent(MotionEvent motionEvent) {
        if (!this.f139724f || !super.dispatchTouchEvent(motionEvent)) {
            return false;
        }
        return true;
    }
    ...
    private c a(View view) {
        for (int i2 = 0; i2 < this.f139726i.size(); i2++) {
            c cVar = this.f139726i.get(i2);
            if (this.f139722c.isViewFromObject(view, cVar.f139737a)) {
                return cVar;
            }
        }
        return null;
    ...
    private c b(int i2) {
        for (int i3 = 0; i3 < this.f139726i.size(); i3++) {
            c cVar = this.f139726i.get(i3);
            if (cVar.f139738b == i2) {
                return cVar;
            }
    ...
    public void addTouchables(ArrayList<View> arrayList) {
        ...
        for (int i2 = 0; i2 < getChildCount(); i2++) {
            ...
            if (childAt.getVisibility() == 0 && (a2 = a(childAt)) != null && a2.f139738b == this.f139723d) {
    ...
    public boolean dispatchPopulateAccessibilityEvent(AccessibilityEvent accessibilityEvent) {
        ...
        for (int i2 = 0; i2 < childCount; i2++) {
            View childAt = getChildAt(i2);
            if (childAt.getVisibility() == 0 && (a2 = a(childAt)) != null && a2.f139738b == this.f139723d && childAt.dispatchPopulateAccessibilityEvent(accessibilityEvent)) {
                return true;
            }
        }
        return false;
    ...
    public void onRestoreInstanceState(Parcelable parcelable) {
        ...
        PagerAdapter pagerAdapter = this.f139722c;
        if (pagerAdapter != null) {
            pagerAdapter.restoreState(savedState.f139735b, savedState.f139736c);
            a(savedState.f139734a, false, true);
            return;
        }
        this.f139729l = savedState.f139734a;
        this.f139730m = savedState.f139735b;
        this.n = savedState.f139736c;
    }
    ...
    public void setChildrenDrawingOrderEnabledCompat(boolean r7) {
        ...
        L_0x0026:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ss.android.ugc.aweme.tools.draft.ftc.view.VerticalViewPager.setChildrenDrawingOrderEnabledCompat(boolean):void");
    }

    private boolean c(int i2) {
        if (this.f139726i.size() != 0) {
            c j2 = j();
            int clientHeight = getClientHeight();
            int i3 = this.r;
            ...
            int i5 = j2.f139738b;
            float f4 = ((((float) i2) / f3) - j2.f139741e) / (j2.f139740d + (f2 / f3));
            this.ab = false;
    ...
    public void draw(Canvas canvas) {
        ...
        boolean z2 = false;
        if (overScrollMode == 0 || (overScrollMode == 1 && (pagerAdapter = this.f139722c) != null && pagerAdapter.getCount() > 1)) {
    ...
    public void onDraw(Canvas canvas) {
        float f2;
        super.onDraw(canvas);
        if (this.r > 0 && this.s != null && this.f139726i.size() > 0 && this.f139722c != null) {
            int scrollY = getScrollY();
            int height = getHeight();
            ...
            c cVar = this.f139726i.get(0);
            float f5 = cVar.f139741e;
            int size = this.f139726i.size();
            int i3 = this.f139726i.get(size - 1).f139738b;
            for (int i4 = cVar.f139738b; i4 < i3; i4++) {
                while (i4 > cVar.f139738b && i2 < size) {
                    i2++;
                    cVar = this.f139726i.get(i2);
                }
                if (i4 == cVar.f139738b) {
                    f2 = (cVar.f139741e + cVar.f139740d) * f3;
                    f5 = cVar.f139741e + cVar.f139740d + f4;
                } else {
                    float pageWidth = this.f139722c.getPageWidth(i4);
                    f2 = (f5 + pageWidth) * f3;
                    f5 += pageWidth + f4;
                }
                int i5 = this.r;
    ...
    public void setAdapter(PagerAdapter pagerAdapter) {
        PagerAdapter pagerAdapter2 = this.f139722c;
        if (pagerAdapter2 != null) {
            ...
            while (i3 < getChildCount()) {
                if (!((d) getChildAt(i3).getLayoutParams()).f139742a) {
                    removeViewAt(i3);
                    i3--;
                }
                i3++;
        ...
        this.f139722c = pagerAdapter;
        this.f139725g = 0;
        if (pagerAdapter != null) {
            if (this.q == null) {
                this.q = new g(this, (byte) 0);
            }
            a(this.f139722c, this.q);
            this.B = false;
            boolean z2 = this.W;
            this.W = true;
            this.f139725g = this.f139722c.getCount();
            if (this.f139729l >= 0) {
                this.f139722c.restoreState(this.f139730m, this.n);
                a(this.f139729l, false, true);
                this.f139729l = -1;
                this.f139730m = null;
                this.n = null;
            } else if (!z2) {
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        try {
            ...
            if ((motionEvent.getAction() != 0 || motionEvent.getEdgeFlags() == 0) && (pagerAdapter = this.f139722c) != null) {
                    ...
                    if (action != 0) {
                        if (action != 1) {
                            ...
                            if (j2 != null) {
                                ...
                                a(a(j2.f139738b, ((((float) scrollY) / f4) - j2.f139741e) / (j2.f139740d + (((float) this.r) / f4)), yVelocity, (int) (motionEvent.getY(motionEvent.findPointerIndex(this.M)) - this.L)), true, true, yVelocity);
                            }
                            z2 = h();
                        }
                        if (z2) {
            ...
            if (this.f139722c.getCount() != this.f139725g) {
                this.f139722c.notifyDataSetChanged();
            }
            e3.printStackTrace();
        }
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:26:0x006c, code lost:
        if (r7.f139738b == r17.f139723d) goto L_0x006e;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:40:0x0094, code lost:
        if (r1 != r13.f139738b) goto L_0x00b4;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:42:0x0098, code lost:
        if (r13.f139739c != false) goto L_0x00b4;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:43:0x009a, code lost:
        r17.f139726i.remove(r12);
        r17.f139722c.destroyItem((android.view.ViewGroup) r17, r1, r13.f139737a);
        r12 = r12 - 1;
        r8 = r8 - 1;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:57:0x00e5, code lost:
        r2 = (2.0f - r7.f139740d) + (((float) getPaddingLeft()) / ((float) r11));
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:87:0x0157, code lost:
        if (r11 != r13.f139738b) goto L_0x016f;
     */
    ...
    public int getChildDrawingOrder(int i2, int i3) {
        ...
        return ((d) this.aj.get(i3).getLayoutParams()).f139747f;
    }
    ...
    public boolean onRequestFocusInDescendants(int i2, Rect rect) {
        ...
        while (i3 != i5) {
            ...
            if (childAt.getVisibility() == 0 && (a2 = a(childAt)) != null && a2.f139738b == this.f139723d && childAt.requestFocus(i2, rect)) {
                return true;
            }
            i3 += i4;
        }
    ...
    private c b(int i2, int i3) {
        c cVar = new c();
        cVar.f139738b = i2;
        cVar.f139737a = this.f139722c.instantiateItem((ViewGroup) this, i2);
        cVar.f139740d = this.f139722c.getPageWidth(i2);
        if (i3 < 0 || i3 >= this.f139726i.size()) {
            this.f139726i.add(cVar);
        } else {
            this.f139726i.add(i3, cVar);
        }
        return cVar;
    }
    ...
    public VerticalViewPager(Context context, AttributeSet attributeSet) {
        ...
        this.o = new Scroller(context2, f139719b);
        ...
        v.a(this, new r() {
            /* class com.ss.android.ugc.aweme.tools.draft.ftc.view.VerticalViewPager.AnonymousClass4 */

            /* renamed from: b  reason: collision with root package name */
            private final Rect f139733b = new Rect();
    ...
    private void a(int i2, int i3) {
        ...
        if (abs2 > 0) {
            ...
            abs = (int) (((((float) Math.abs(i4)) / ((f2 * this.f139722c.getPageWidth(this.f139723d)) + ((float) this.r))) + 1.0f) * 100.0f);
        }
    ...
    public void addView(View view, int i2, ViewGroup.LayoutParams layoutParams) {
        ...
        dVar.f139742a |= view instanceof a;
        if (!this.z) {
            super.addView(view, i2, layoutParams);
        } else if (!dVar.f139742a) {
            dVar.f139745d = true;
    ...
    private void a(int i2, float f2, int i3) {
        ...
        if (this.ag != null) {
            ...
            for (int i8 = 0; i8 < childCount2; i8++) {
                ...
                if (!((d) childAt2.getLayoutParams()).f139742a) {
    ...
    private int a(int i2, float f2, int i3, int i4) {
        ...
        ArrayList<c> arrayList = this.f139726i;
        return Math.max(this.f139726i.get(0).f139738b, Math.min(i2, arrayList.get(arrayList.size() - 1).f139738b));
    }
    ...
    public void onLayout(boolean z2, int i2, int i3, int i4, int i5) {
        ...
        for (int i13 = 0; i13 < childCount; i13++) {
            ...
            if (childAt.getVisibility() != 8) {
                d dVar = (d) childAt.getLayoutParams();
                if (dVar.f139742a) {
                    int i14 = dVar.f139743b & 7;
                    int i15 = dVar.f139743b & 112;
                    if (i14 == 1) {
        ...
        for (int i18 = 0; i18 < childCount; i18++) {
            ...
            if (childAt2.getVisibility() != 8) {
                ...
                c a2 = a(childAt2);
                if (!dVar2.f139742a && a2 != null) {
                    float f2 = (float) i17;
                    int i19 = ((int) (a2.f139741e * f2)) + paddingTop;
                    if (dVar2.f139745d) {
                        dVar2.f139745d = false;
                        childAt2.measure(View.MeasureSpec.makeMeasureSpec((i10 - paddingLeft) - paddingRight, 1073741824), View.MeasureSpec.makeMeasureSpec((int) (f2 * dVar2.f139744c), 1073741824));
                    }
