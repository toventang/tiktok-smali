...
public final class FTCEditCornerState extends UiState {
    ...
    public static /* synthetic */ FTCEditCornerState copy$default(FTCEditCornerState fTCEditCornerState, Boolean bool, Integer num, Integer num2, a aVar, int i2, Object obj) {
        if ((i2 & 1) != 0) {
    ...
    public final FTCEditCornerState copy(Boolean bool, Integer num, Integer num2, a aVar) {
        l.d(aVar, "");
    ...
    public final boolean equals(Object obj) {
        ...
        return l.a(this.cornerVisible, fTCEditCornerState.cornerVisible) && l.a(this.topMargin, fTCEditCornerState.topMargin) && l.a(this.bottomMargin, fTCEditCornerState.bottomMargin) && l.a(getUi(), fTCEditCornerState.getUi());
    }
    ...
    public FTCEditCornerState(Boolean bool, Integer num, Integer num2, a aVar) {
        super(aVar);
        l.d(aVar, "");
    ...
    public /* synthetic */ FTCEditCornerState(Boolean bool, Integer num, Integer num2, a aVar, int i2, g gVar) {
