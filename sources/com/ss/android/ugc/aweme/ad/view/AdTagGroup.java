...
public final class AdTagGroup extends ViewGroup {
    ...
    public final void setTagList(String[] strArr) {
        ...
        for (String str : strArr) {
            ...
            l.b(context, "");
            frameLayout.setBackground(context.getResources().getDrawable(R.drawable.pg));
        ...
        if (mode == Integer.MIN_VALUE) {
            ...
            for (int i6 = 0; i6 < childCount; i6++) {
                ...
                if (i6 != 0) {
                    ...
                    childAt.layout(i7 + i4, 0, childAt.getMeasuredWidth() + i4 + this.f66172a, childAt.getMeasuredHeight());
                    i4 += this.f66172a;
    ...
    private /* synthetic */ AdTagGroup(Context context, AttributeSet attributeSet, byte b2) {
        this(context, attributeSet, (char) 0);
    }

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    private AdTagGroup(Context context, AttributeSet attributeSet, char c2) {
        super(context, attributeSet, 0);
        l.d(context, "");
        MethodCollector.i(3784);
        this.f66172a = n.a(4.0d);
    ...
    public final void onLayout(boolean z, int i2, int i3, int i4, int i5) {
        ...
        while (true) {
            ...
            if (i6 != 0) {
                ...
                childAt.layout(i8 + i7, 0, childAt.getMeasuredWidth() + i7 + this.f66172a, childAt.getMeasuredHeight());
                i7 += this.f66172a;
            } else {
                l.b(childAt, "");
