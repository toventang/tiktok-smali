...
public class ProfileWidget extends Widget implements ar<i>, q, au {

    /* renamed from: g  reason: collision with root package name */
    private final h f117567g;
    public i q = new i();
    ...
    public final ProfileViewModel r() {
        return (ProfileViewModel) this.f117567g.getValue();
    }
    ...
    public ProfileWidget() {
        c a2 = ab.a(ProfileViewModel.class);
        this.f117567g = h.i.a((h.f.a.a) new a(this, a2, a2));
    }

    public static final class a extends h.f.b.m implements h.f.a.a<ProfileViewModel> {
        ...
        public final com.ss.android.ugc.aweme.profile.viewmodel.ProfileViewModel invoke() {
            /*
            // Method dump skipped, instructions count: 117
            */
            throw new UnsupportedOperationException("Method not decompiled: com.ss.android.ugc.aweme.profile.widgets.ProfileWidget.a.invoke():com.bytedance.jedi.arch.JediViewModel");
        }

        public static ac com_ss_android_ugc_aweme_profile_widgets_ProfileWidget$$special$$inlined$hostViewModel$1_androidx_lifecycle_VScopeLancet_get(ad adVar, String str, Class cls) {
