...
public final class h extends o {
    ...
    public static final a f134553a = new a((byte) 0);

    static {
        Covode.recordClassIndex(87928);
    }
    ...
    public h(final Context context, final i iVar) {
        ...
        setOnKeyListener(AnonymousClass1.f134554a);
        ((TuxIconView) findViewById(R.id.a7k)).setOnClickListener(new View.OnClickListener(this) {
            /* class com.ss.android.ugc.aweme.specact.popup.b.h.AnonymousClass2 */

            /* renamed from: a  reason: collision with root package name */
            final /* synthetic */ h f134555a;
            ...
            public final void onClick(View view) {
                ...
                r.a("invite_result_notification_pop_click", new d().a("position", "feed").a("button_name", "close").f66730a);
                SpecActRedPacketApi.a.a(iVar, "True");
                this.f134555a.dismiss();
            }
        });
        ...
        if (str.length() > 0) {
            ((TuxTextView) findViewById(R.id.button)).setOnClickListener(new View.OnClickListener(this) {
                /* class com.ss.android.ugc.aweme.specact.popup.b.h.AnonymousClass3 */

                /* renamed from: a  reason: collision with root package name */
                final /* synthetic */ h f134557a;
                ...
                public final void onClick(View view) {
                    ...
                    r.a("invite_result_notification_pop_click", new d().a("position", "feed").a("button_name", "ok").f66730a);
                    SpecActRedPacketApi.a.a(iVar, "False");
                    this.f134557a.dismiss();
                }
            });
        }
        r.a("invite_result_notification_pop_show", new d().a("position", "feed").f66730a);
    }
}
