...
public final class FollowRelationTabActivity extends com.bytedance.ies.foundation.activity.a implements com.bytedance.analytics.page.b, ar<i>, q {

    /* renamed from: b  reason: collision with root package name */
    public static final int f96373b = 1;

    /* renamed from: c  reason: collision with root package name */
    public static final c f96374c = new c((byte) 0);

    /* renamed from: a  reason: collision with root package name */
    public i f96375a = new i();

    /* renamed from: d  reason: collision with root package name */
    private final lifecycleAwareLazy f96376d;

    /* renamed from: e  reason: collision with root package name */
    private SparseArray f96377e;

    public static final class a extends m implements h.f.a.m<FollowRelationState, Bundle, FollowRelationState> {
    ...
    public final void _$_clearFindViewByIdCache() {
        SparseArray sparseArray = this.f96377e;
        if (sparseArray != null) {
            sparseArray.clear();
        }
    }
    ...
    public final View _$_findCachedViewById(int i2) {
        if (this.f96377e == null) {
            this.f96377e = new SparseArray();
        }
        View view = (View) this.f96377e.get(i2);
        if (view != null) {
            return view;
        }
        View findViewById = findViewById(i2);
        this.f96377e.put(i2, findViewById);
        return findViewById;
    }
    ...
    public FollowRelationTabActivity() {
        ...
        this.f96376d = new lifecycleAwareLazy(this, new b(this, a2, a.INSTANCE, a2));
    }
    ...
    public static final class b extends m implements h.f.a.a<FollowRelationTabViewModel> {
        ...
        public final com.ss.android.ugc.aweme.following.ui.viewmodel.FollowRelationTabViewModel invoke() {
            /*
                ...
                java.lang.Class r0 = h.f.a.a(r0)
                androidx.lifecycle.ac r2 = com_ss_android_ugc_aweme_following_ui_FollowRelationTabActivity$$special$$inlined$viewModel$2_androidx_lifecycle_VScopeLancet_get(r2, r1, r0)
            ...
            L_0x0038:
                ...
                return r2
            */
            throw new UnsupportedOperationException("Method not decompiled: com.ss.android.ugc.aweme.following.ui.FollowRelationTabActivity.b.invoke():com.bytedance.jedi.arch.JediViewModel");
        }

        public static ac com_ss_android_ugc_aweme_following_ui_FollowRelationTabActivity$$special$$inlined$viewModel$2_androidx_lifecycle_VScopeLancet_get(ad adVar, String str, Class cls) {
    ...
    static final class d extends m implements h.f.a.b<BaseActivityViewModel, z> {
        ...
        /* renamed from: a  reason: collision with root package name */
        public static final d f96378a = new d();
        ...
        public final /* synthetic */ z invoke(BaseActivityViewModel baseActivityViewModel) {
            ...
            baseActivityViewModel2.config(AnonymousClass1.f96379a);
            baseActivityViewModel2.config(AnonymousClass2.f96380a);
            return z.f158842a;
        }
    }
    ...
    public final void onCreate(Bundle bundle) {
        ...
        activityConfiguration(d.f96378a);
        ...
        a2.setArguments(a(getIntent()));
        n a3 = getSupportFragmentManager().a();
        l.b(a3, "");
        a3.b(R.id.b94, a2, "follow_relation_tab").c();
