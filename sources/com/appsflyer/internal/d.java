...
public class d {
    ...
    public static byte[] f238;

    /* renamed from: ł  reason: contains not printable characters */
    private static Object f239;

    /* renamed from: ſ  reason: contains not printable characters */
    private static int f240;

    /* renamed from: Ɨ  reason: contains not printable characters */
    private static int f241 = -3;

    /* renamed from: ƚ  reason: contains not printable characters */
    private static final byte[] f242 = null;

    /* renamed from: ɍ  reason: contains not printable characters */
    private static long f243 = -4563979436785797051L;
    ...
    private static Object com_appsflyer_internal_d_java_lang_reflect_Method_invoke(Method method, Object obj, Object[] objArr) {
        Pair<Boolean, Object> a2 = a.a(method, new Object[]{obj, objArr}, 110000, "java.lang.Object", true, "com_appsflyer_internal_d_java_lang_reflect_Method_invoke(Ljava/lang/reflect/Method;Ljava/lang/Object;[Ljava/lang/Object;)Ljava/lang/Object;");
        if (((Boolean) a2.first).booleanValue()) {
            return a2.second;
        }
        Object invoke = method.invoke(obj, objArr);
        a.a(invoke, method, new Object[]{obj, objArr}, "com_appsflyer_internal_d_java_lang_reflect_Method_invoke(Ljava/lang/reflect/Method;Ljava/lang/Object;[Ljava/lang/Object;)Ljava/lang/Object;");
        return invoke;
    }

    /* renamed from: ǃ  reason: contains not printable characters */
    public static Object m179(int i2, char c2, int i3) {
        int i4 = f246;
        ...
        try {
            ...
            byte[] bArr = f242;
            Class<?> cls = Class.forName($$c((short) bArr[544], (byte) bArr[288], 854), true, (ClassLoader) f239);
            byte b2 = (byte) bArr[71];
            Object com_appsflyer_internal_d_java_lang_reflect_Method_invoke = com_appsflyer_internal_d_java_lang_reflect_Method_invoke(cls.getMethod($$c(374, b2, (short) (b2 | 648)), Integer.TYPE, Character.TYPE, Integer.TYPE), obj, objArr);
            int i9 = f246 + 49;
            f244 = i9 % 128;
            int i10 = i9 % 2;
    ...
    public static int m180(int i2) {
        int i3 = f246;
        int i4 = (i3 + 28) - 1;
        f244 = i4 % 128;
        int i5 = i4 % 2;
        Object obj = f245;
        int i6 = ((i3 | 101) << 1) - (i3 ^ 101);
        f244 = i6 % 128;
        int i7 = i6 % 2;
        try {
            ...
            Class<?> cls = Class.forName($$c((short) bArr[544], (byte) bArr[288], 854), true, (ClassLoader) f239);
            byte b2 = (byte) bArr[71];
            int intValue = ((Integer) com_appsflyer_internal_d_java_lang_reflect_Method_invoke(cls.getMethod($$c(730, b2, (short) (b2 | 336)), Integer.TYPE), obj, objArr)).intValue();
            int i8 = f244 + 67;
            f246 = i8 % 128;
            int i9 = i8 % 2;
            return intValue;
    ...
    public static int m181(Object obj) {
        ...
        if (i3 % 2 == 0) {
            ...
            try {
                ...
                Class<?> cls = Class.forName($$c((short) bArr[544], (byte) bArr[288], 854), true, (ClassLoader) f239);
                byte b2 = (byte) bArr[71];
                return ((Integer) com_appsflyer_internal_d_java_lang_reflect_Method_invoke(cls.getMethod($$c(382, b2, (short) b2), Object.class), obj2, objArr)).intValue();
            } catch (Throwable th) {
                Throwable cause = th.getCause();
                if (cause != null) {
                    throw cause;
