...
public final class e {
    ...
    public final t f57831a;

    /* renamed from: b  reason: collision with root package name */
    public volatile boolean f57832b;
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:450:0x0804, code lost:
        if (r1.f57671b.w == false) goto L_0x0806;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:452:0x0807, code lost:
        r3 = new com.squareup.a.a.b.h(r1.f57671b, r1.f57678i, r1.f57677h, r1.o, r1.p, r1.b(), null, r1.f57673d);
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:460:0x082d, code lost:
        r3.a(r4.getLastConnectException());
     */
    ...
    public final com.squareup.a.x a(com.squareup.a.v r36, boolean r37) {
        /*
        // Method dump skipped, instructions count: 2292
        */
        throw new UnsupportedOperationException("Method not decompiled: com.squareup.a.e.a(com.squareup.a.v, boolean):com.squareup.a.x");
    }
    ...
    public final x a() {
        ...
        try {
            this.f57831a.f57908d.a(this);
            x a2 = new a(0, this.f57833c, false).a(this.f57833c);
            if (a2 != null) {
                return a2;
            }
    ...
    public class a implements r.a {
        ...
        public final x a(v vVar) {
            if (this.f57837b >= e.this.f57831a.f57912h.size()) {
                return e.this.a(vVar, this.f57839d);
            }
            new a(this.f57837b + 1, vVar, this.f57839d);
            r rVar = e.this.f57831a.f57912h.get(this.f57837b);
            x a2 = rVar.a();
            if (a2 != null) {
                return a2;
            }
    ...
    protected e(t tVar, v vVar) {
        t tVar2 = new t(tVar);
        if (tVar2.f57914j == null) {
            tVar2.f57914j = ProxySelector.getDefault();
        }
        if (tVar2.f57915k == null) {
            tVar2.f57915k = CookieHandler.getDefault();
        }
        if (tVar2.n == null) {
            tVar2.n = SocketFactory.getDefault();
        }
        if (tVar2.o == null) {
            tVar2.o = tVar.a();
        }
        ...
        if (tVar2.r == null) {
            tVar2.r = com.squareup.a.a.b.a.f57600a;
        }
        if (tVar2.s == null) {
            tVar2.s = j.f57846a;
        }
        if (tVar2.f57910f == null) {
            tVar2.f57910f = t.f57905a;
        }
        if (tVar2.f57911g == null) {
            tVar2.f57911g = t.f57906b;
        }
        if (tVar2.t == null) {
            tVar2.t = n.f57872a;
        }
