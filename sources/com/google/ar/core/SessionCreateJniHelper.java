...
class SessionCreateJniHelper {
    ...
    static int getMinApkVersion(Context context) {
        try {
            Bundle bundle = a(context.getPackageManager(), context.getPackageName()).metaData;
    ...
    static boolean checkApkSignature(Context context) {
        try {
            ...
            return a(context.getPackageManager(), context.getPackageName()).metaData.getBoolean("com.google.ar.core.disable_security_check", false);
        } catch (PackageManager.NameNotFoundException unused) {
            return true;
        }
    }
