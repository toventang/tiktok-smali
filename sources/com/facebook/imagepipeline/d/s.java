...
public final class s implements h.a {
    ...
    /* renamed from: com.facebook.imagepipeline.d.s$1  reason: invalid class name */
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            /*
                r0 = 28964(0x7124, float:4.0587E-41)
                com.bytedance.covode.number.Covode.recordClassIndex(r0)
                com.facebook.common.g.b[] r0 = com.facebook.common.g.b.values()
                int r0 = r0.length
                int[] r2 = new int[r0]
                com.facebook.imagepipeline.d.s.AnonymousClass1.f47822a = r2
            ...
            L_0x0017:
                int[] r2 = com.facebook.imagepipeline.d.s.AnonymousClass1.f47822a     // Catch:{ NoSuchFieldError -> 0x0022 }
                com.facebook.common.g.b r0 = com.facebook.common.g.b.OnAppBackgrounded     // Catch:{ NoSuchFieldError -> 0x0022 }
                int r1 = r0.ordinal()     // Catch:{ NoSuchFieldError -> 0x0022 }
                r0 = 2
                r2[r1] = r0     // Catch:{ NoSuchFieldError -> 0x0022 }
            L_0x0022:
                int[] r2 = com.facebook.imagepipeline.d.s.AnonymousClass1.f47822a     // Catch:{ NoSuchFieldError -> 0x002d }
            ...
            L_0x002d:
                int[] r2 = com.facebook.imagepipeline.d.s.AnonymousClass1.f47822a     // Catch:{ NoSuchFieldError -> 0x0038 }
            ...
            L_0x0038:
                int[] r2 = com.facebook.imagepipeline.d.s.AnonymousClass1.f47822a     // Catch:{ NoSuchFieldError -> 0x0043 }
            ...
            L_0x0043:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.imagepipeline.d.s.AnonymousClass1.<clinit>():void");
        }
    }

    @Override // com.facebook.imagepipeline.d.h.a
    public final double a(b bVar) {
        int i2 = AnonymousClass1.f47822a[bVar.ordinal()];
        if (i2 == 1) {
            return 0.0d;
        }
        ...
        a.d("NativeMemoryCacheTrimStrategy", "unknown trim type: %s", bVar);
        return 0.0d;
    }
}
