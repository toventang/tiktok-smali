...
public class hl extends a {
    ...
    public final void a() {
        ...
        this.f30626c.close();
        this.f30626c.moveTo(27.0f, 32.0f);
        this.f30626c.cubicTo(27.0f, 33.6569f, 25.6569f, 35.0f, 24.0f, 35.0f);
        this.f30626c.cubicTo(22.3431f, 35.0f, 21.0f, 33.6569f, 21.0f, 32.0f);
        this.f30626c.cubicTo(21.0f, 30.3431f, 22.3431f, 29.0f, 24.0f, 29.0f);
        this.f30626c.cubicTo(25.6569f, 29.0f, 27.0f, 30.3431f, 27.0f, 32.0f);
        this.f30626c.close();
        this.f30626c.moveTo(23.0f, 13.0f);
        this.f30626c.cubicTo(22.4477f, 13.0f, 22.0f, 13.4477f, 22.0f, 14.0f);
        this.f30626c.lineTo(22.0f, 25.0f);
        this.f30626c.cubicTo(22.0f, 25.5523f, 22.4477f, 26.0f, 23.0f, 26.0f);
        this.f30626c.lineTo(25.0f, 26.0f);
        this.f30626c.cubicTo(25.5523f, 26.0f, 26.0f, 25.5523f, 26.0f, 25.0f);
        this.f30626c.lineTo(26.0f, 14.0f);
        this.f30626c.cubicTo(26.0f, 13.4477f, 25.5523f, 13.0f, 25.0f, 13.0f);
        this.f30626c.lineTo(23.0f, 13.0f);
        this.f30626c.close();
