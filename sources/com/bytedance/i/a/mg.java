...
public class mg extends a {
    ...
    public final void a() {
        this.f30626c.moveTo(16.0f, 10.554f);
        this.f30626c.lineTo(16.0f, 37.4459f);
        this.f30626c.lineTo(38.1463f, 24.0f);
        this.f30626c.lineTo(16.0f, 10.554f);
        this.f30626c.close();
