...
public final class af extends w {
    ...
    public final void a(k kVar, Runnable runnable) {
        ...
        d.a(new c<List<ai>>() {
            /* class com.bytedance.im.core.internal.b.a.af.AnonymousClass3 */
            ...
            public List<ai> a() {
                int i2;
                aw a2;
                b.a("LoadNewerHandler.saveMsg(String,List,boolean)");
                ...
                try {
                    ...
                    b.a("LoadNewerHandler.saveMsg(String,List,boolean)", true);
                    Collections.sort(arrayList);
                } catch (Exception e2) {
                    b.a("LoadNewerHandler.saveMsg(String,List,boolean)", false);
                    f.b("imsdk", "LoadNewerHandler saveMsg", e2);
                    com.bytedance.im.core.g.b.a(1, e2);
                }
                return arrayList;
            }
        }, new com.bytedance.im.core.internal.e.b<List<ai>>() {
            /* class com.bytedance.im.core.internal.b.a.af.AnonymousClass4 */
