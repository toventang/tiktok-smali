...
public final class UpsertConversationSettingExtInfoRequestBody extends Message<UpsertConversationSettingExtInfoRequestBody, Builder> {
    ...
    static final class ProtoAdapter_UpsertConversationSettingExtInfoRequestBody extends ProtoAdapter<UpsertConversationSettingExtInfoRequestBody> {
        ...
        public final com.bytedance.im.core.proto.UpsertConversationSettingExtInfoRequestBody redact(com.bytedance.im.core.proto.UpsertConversationSettingExtInfoRequestBody r2) {
            /*
                r1 = this;
                ...
                return r0
            */
            throw new UnsupportedOperationException("Method not decompiled: com.bytedance.im.core.proto.UpsertConversationSettingExtInfoRequestBody.ProtoAdapter_UpsertConversationSettingExtInfoRequestBody.redact(com.bytedance.im.core.proto.UpsertConversationSettingExtInfoRequestBody):com.bytedance.im.core.proto.UpsertConversationSettingExtInfoRequestBody");
        }
    ...
    public final String toString() {
        return "UpsertConversationSettingExtInfoRequestBody" + h.f38770a.b(this).toString();
    }
    ...
    public UpsertConversationSettingExtInfoRequestBody(String str, Long l2, Integer num, Map<String, String> map) {
        this(str, l2, num, map, i.EMPTY);
    }

    public UpsertConversationSettingExtInfoRequestBody(String str, Long l2, Integer num, Map<String, String> map, i iVar) {
        super(ADAPTER, iVar);
        this.conversation_id = str;
        this.conversation_short_id = l2;
        this.conversation_type = num;
