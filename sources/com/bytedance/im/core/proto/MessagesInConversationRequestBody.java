...
public final class MessagesInConversationRequestBody extends Message<MessagesInConversationRequestBody, Builder> {
    ...
    static final class ProtoAdapter_MessagesInConversationRequestBody extends ProtoAdapter<MessagesInConversationRequestBody> {
        ...
        public final com.bytedance.im.core.proto.MessagesInConversationRequestBody redact(com.bytedance.im.core.proto.MessagesInConversationRequestBody r2) {
            /*
                r1 = this;
                ...
                return r0
            */
            throw new UnsupportedOperationException("Method not decompiled: com.bytedance.im.core.proto.MessagesInConversationRequestBody.ProtoAdapter_MessagesInConversationRequestBody.redact(com.bytedance.im.core.proto.MessagesInConversationRequestBody):com.bytedance.im.core.proto.MessagesInConversationRequestBody");
        }
    ...
    public final String toString() {
        return "MessagesInConversationRequestBody" + h.f38770a.b(this).toString();
    }
    ...
    public MessagesInConversationRequestBody(String str, Integer num, Long l2, MessageDirection messageDirection, Long l3, Integer num2, i iVar) {
        super(ADAPTER, iVar);
        this.conversation_id = str;
        this.conversation_type = num;
        this.conversation_short_id = l2;
