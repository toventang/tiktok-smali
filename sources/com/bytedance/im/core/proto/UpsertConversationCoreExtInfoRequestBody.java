...
public final class UpsertConversationCoreExtInfoRequestBody extends Message<UpsertConversationCoreExtInfoRequestBody, Builder> {
    ...
    static final class ProtoAdapter_UpsertConversationCoreExtInfoRequestBody extends ProtoAdapter<UpsertConversationCoreExtInfoRequestBody> {
        ...
        public final com.bytedance.im.core.proto.UpsertConversationCoreExtInfoRequestBody redact(com.bytedance.im.core.proto.UpsertConversationCoreExtInfoRequestBody r2) {
            /*
                r1 = this;
    ...
    public final String toString() {
        return "UpsertConversationCoreExtInfoRequestBody" + h.f38770a.b(this).toString();
    }
    ...
    public UpsertConversationCoreExtInfoRequestBody(String str, Long l2, Integer num, Map<String, String> map) {
        this(str, l2, num, map, i.EMPTY);
    }

    public UpsertConversationCoreExtInfoRequestBody(String str, Long l2, Integer num, Map<String, String> map, i iVar) {
        super(ADAPTER, iVar);
        this.conversation_id = str;
        this.conversation_short_id = l2;
        this.conversation_type = num;
