...
import com.bytedance.android.live.design.widget.tintable.f;
import com.bytedance.covode.number.Covode;

public class ShapeControllableRelativeLayout extends f {

    /* renamed from: a  reason: collision with root package name */
    private a<ShapeControllableRelativeLayout> f9599a;
    ...
    public float getBottomLeftRadius() {
        return this.f9599a.f9606f;
    }

    public float getBottomRightRadius() {
        return this.f9599a.f9607g;
    }

    public float getRadius() {
        return this.f9599a.f9603c;
    }

    public ColorStateList getStrokeColor() {
        return this.f9599a.f9602b;
    }

    public float getStrokeWidth() {
        return this.f9599a.f9601a;
    }

    public float getTopLeftRadius() {
        return this.f9599a.f9604d;
    }

    public float getTopRightRadius() {
        return this.f9599a.f9605e;
    }
    ...
    public void draw(Canvas canvas) {
        this.f9599a.b(canvas);
        super.draw(canvas);
        this.f9599a.c(canvas);
    }

    /* access modifiers changed from: protected */
    public void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        this.f9599a.a(canvas);
    }
