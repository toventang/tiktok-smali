...
public class e implements m {
    ...
    private static boolean f36665e;
    ...
    public final void a(Surface surface) {
        n nVar;
        if ((surface == null || surface.isValid()) && (nVar = this.f36668d) != null) {
            nVar.a(surface);
        }
    }
            ...
            try {
                if (r.a()) {
                    try {
                        ...
                        Method declaredMethod = cls.getDeclaredMethod("create", m.class, Context.class);
                        declaredMethod.setAccessible(true);
                        eVar.f36668d = (n) declaredMethod.invoke(cls, eVar, context);
                        f36665e = true;
                    } catch (Throwable th) {
                        eVar.f36666a = true;
                        eVar.f36667b = th.toString();
                    }
                    if (eVar.f36668d == null) {
                        try {
                            Class<?> cls2 = Class.forName("com.ss.ttmplayer.player.TTPlayerClient");
                            Method declaredMethod2 = cls2.getDeclaredMethod("create", m.class, Context.class);
                            declaredMethod2.setAccessible(true);
                            eVar.f36668d = (n) declaredMethod2.invoke(cls2, eVar, context);
                        } catch (Throwable th2) {
                            eVar.f36666a = true;
                            eVar.f36667b = th2.toString();
                        }
                    }
                }
                if (eVar.f36668d == null) {
                    eVar.f36668d = o.a(eVar);
                }
            } finally {
