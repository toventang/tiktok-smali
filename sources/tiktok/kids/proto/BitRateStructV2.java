...
public final class BitRateStructV2 extends Message<BitRateStructV2, Builder> {
    ...
    public BitRateStructV2(String str, Integer num, Integer num2, UrlStructV2 urlStructV2, Integer num3, UrlStructV2 urlStructV22, UrlStructV2 urlStructV23) {
        this(str, num, num2, urlStructV2, num3, urlStructV22, urlStructV23, i.EMPTY);
    }

    public BitRateStructV2(String str, Integer num, Integer num2, UrlStructV2 urlStructV2, Integer num3, UrlStructV2 urlStructV22, UrlStructV2 urlStructV23, i iVar) {
        super(ADAPTER, iVar);
        this.gear_name = str;
        this.quality_type = num;
        this.bit_rate = num2;
