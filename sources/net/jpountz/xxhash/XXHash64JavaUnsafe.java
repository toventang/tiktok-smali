...
final class XXHash64JavaUnsafe extends XXHash64 {
    ...
    public final long hash(byte[] bArr, int i2, int i3, long j2) {
        long j3;
        int i4 = i2;
        UnsafeUtils.checkRange(bArr, i4, i3);
        int i5 = i4 + i3;
        long j4 = -4417276706812531889L;
        if (i3 >= 32) {
            int i6 = i5 - 32;
            ...
            long j8 = j2 - -7046029288634856825L;
            while (true) {
                j5 = Long.rotateLeft(j5 + (UnsafeUtils.readLongLE(bArr, i4) * j4), 31) * -7046029288634856825L;
                int i7 = i4 + 8;
                j6 = Long.rotateLeft(j6 + (UnsafeUtils.readLongLE(bArr, i7) * j4), 31) * -7046029288634856825L;
                int i8 = i7 + 8;
                j7 = Long.rotateLeft(j7 + (UnsafeUtils.readLongLE(bArr, i8) * j4), 31) * -7046029288634856825L;
                int i9 = i8 + 8;
                j8 = Long.rotateLeft(j8 + (UnsafeUtils.readLongLE(bArr, i9) * -4417276706812531889L), 31) * -7046029288634856825L;
                i4 = i9 + 8;
                if (i4 > i6) {
                    break;
                }
        ...
        long j9 = j3 + ((long) i3);
        while (i4 <= i5 - 8) {
            j9 = (Long.rotateLeft(j9 ^ (Long.rotateLeft(UnsafeUtils.readLongLE(bArr, i4) * -4417276706812531889L, 31) * -7046029288634856825L), 27) * -7046029288634856825L) - 8796714831421723037L;
            i4 += 8;
        }
        if (i4 <= i5 - 4) {
            j9 = (Long.rotateLeft(j9 ^ ((((long) UnsafeUtils.readIntLE(bArr, i4)) & 4294967295L) * -7046029288634856825L), 23) * -4417276706812531889L) + 1609587929392839161L;
            i4 += 4;
        }
        while (i4 < i5) {
            j9 = Long.rotateLeft(j9 ^ (((long) (UnsafeUtils.readByte(bArr, i4) & 255)) * 2870177450012600261L), 11) * -7046029288634856825L;
            i4++;
        }
