...
final class StreamingXXHash32JavaUnsafe extends AbstractStreamingXXHash32Java {
    ...
    public final int getValue() {
        ...
        while (i4 <= this.memSize - 4) {
            i3 = Integer.rotateLeft(i3 + (UnsafeUtils.readIntLE(this.memory, i4) * -1028477379), 17) * 668265263;
            i4 += 4;
        }
        while (i4 < this.memSize) {
            i3 = Integer.rotateLeft(i3 + ((UnsafeUtils.readByte(this.memory, i4) & 255) * 374761393), 11) * -1640531535;
            i4++;
        }
