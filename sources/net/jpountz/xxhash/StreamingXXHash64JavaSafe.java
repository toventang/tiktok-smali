...
final class StreamingXXHash64JavaSafe extends AbstractStreamingXXHash64Java {
    ...
    static class Factory implements StreamingXXHash64.Factory {
        ...
        public StreamingXXHash64 newStreamingHash(long j2) {
            return new StreamingXXHash64JavaSafe(j2);
        }
    }
    ...
    public final long getValue() {
        ...
        while (i2 <= this.memSize - 8) {
            j7 = (Long.rotateLeft(j7 ^ (Long.rotateLeft(SafeUtils.readLongLE(this.memory, i2) * -4417276706812531889L, 31) * -7046029288634856825L), 27) * -7046029288634856825L) - 8796714831421723037L;
            i2 += 8;
        }
        if (i2 <= this.memSize - 4) {
            j7 = (Long.rotateLeft(j7 ^ ((((long) SafeUtils.readIntLE(this.memory, i2)) & 4294967295L) * -7046029288634856825L), 23) * -4417276706812531889L) + 1609587929392839161L;
            i2 += 4;
        }
    ...
    StreamingXXHash64JavaSafe(long j2) {
        super(j2);
    }
    ...
    public final void update(byte[] bArr, int i2, int i3) {
        ...
        long j6 = this.v4;
        while (i4 <= i6) {
            j3 = Long.rotateLeft(j3 + (SafeUtils.readLongLE(bArr, i4) * j2), 31) * -7046029288634856825L;
            int i7 = i4 + 8;
            ...
            int i9 = i8 + 8;
            j6 = Long.rotateLeft(j6 + (SafeUtils.readLongLE(bArr, i9) * -4417276706812531889L), 31) * -7046029288634856825L;
            i4 = i9 + 8;
