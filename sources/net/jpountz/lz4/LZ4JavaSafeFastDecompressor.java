...
final class LZ4JavaSafeFastDecompressor extends LZ4FastDecompressor {
    ...
    public final int decompress(byte[] bArr, int i2, byte[] bArr2, int i3, int i4) {
        ...
        if (i4 != 0) {
            ...
            while (true) {
                ...
                if (i12 <= i13) {
                    ...
                    int i14 = i10 + i11;
                    int readShortLE = SafeUtils.readShortLE(bArr, i14);
                    i8 = i14 + 2;
                    int i15 = i12 - readShortLE;
                    if (i15 >= i3) {
                        int i16 = readByte3 & 15;
                        if (i16 == 15) {
                            while (true) {
                                i5 = i8 + 1;
                                readByte = SafeUtils.readByte(bArr, i8);
                                if (readByte != -1) {
                                    break;
                                }
                                i16 += 255;
                        ...
                        i9 = i12 + i17;
                        if (i9 <= i13) {
                            LZ4SafeUtils.wildIncrementalCopy(bArr2, i15, i12, i9);
                        } else if (i9 <= i7) {
        ...
        } else if (SafeUtils.readByte(bArr, i2) == 0) {
            return 1;
        } else {
            throw new LZ4Exception("Malformed input at ".concat(String.valueOf(i2)));
        }
