...
public final class LZ4HCJavaUnsafeCompressor extends LZ4Compressor {
    ...
    public class HashTable {
        ...
        public boolean insertAndFindBestMatch(byte[] bArr, int i2, int i3, LZ4Utils.Match match) {
            ...
            if (hashPointer < i2 - 4 || hashPointer > i2 || hashPointer < this.base) {
                ...
                if (LZ4UnsafeUtils.readIntEquals(bArr, hashPointer, i2)) {
                    i4 = i2 - hashPointer;
                    i5 = LZ4UnsafeUtils.commonBytes(bArr, hashPointer + 4, i2 + 4, i3) + 4;
                    match.len = i5;
                    match.ref = hashPointer;
                } else {
                    i4 = 0;
            ...
            for (int i6 = 0; i6 < LZ4HCJavaUnsafeCompressor.this.maxAttempts && hashPointer >= Math.max(this.base, (i2 - 65536) + 1) && hashPointer <= i2; i6++) {
                if (LZ4UnsafeUtils.readIntEquals(bArr, hashPointer, i2) && (commonBytes = LZ4UnsafeUtils.commonBytes(bArr, hashPointer + 4, i2 + 4, i3) + 4) > match.len) {
                    match.ref = hashPointer;
                    match.len = commonBytes;
                }
                hashPointer = next(hashPointer);
            ...
            if (i5 != 0) {
                ...
                do {
                    this.chainTable[i2 & 65535] = (short) i4;
                    this.hashTable[LZ4Utils.hashHC(UnsafeUtils.readInt(bArr, i2))] = i2;
                    i2++;
                } while (i2 < i7);
                this.nextToUpdate = i7;
            }
        ...
        public boolean insertAndFindWiderMatch(byte[] bArr, int i2, int i3, int i4, int i5, LZ4Utils.Match match) {
            ...
            int hashPointer = hashPointer(bArr, i2);
            for (int i6 = 0; i6 < LZ4HCJavaUnsafeCompressor.this.maxAttempts && hashPointer >= Math.max(this.base, (i2 - 65536) + 1) && hashPointer <= i2; i6++) {
                if (LZ4UnsafeUtils.readIntEquals(bArr, hashPointer, i2) && (commonBytes = LZ4UnsafeUtils.commonBytes(bArr, hashPointer + 4, i2 + 4, i4) + 4 + (commonBytesBackward = LZ4UnsafeUtils.commonBytesBackward(bArr, hashPointer, i2, this.base, i3))) > match.len) {
                    match.len = commonBytes;
                    match.ref = hashPointer - commonBytesBackward;
                    match.start = i2 - commonBytesBackward;
                }
    ...
    public final int compress(byte[] bArr, int i2, int i3, byte[] bArr2, int i4, int i5) {
        int i6 = i2;
        UnsafeUtils.checkRange(bArr, i6, i3);
            ...
            if (!hashTable.insertAndFindBestMatch(bArr, i11, i10, match2)) {
                ...
                while (true) {
                    if (match2.end() >= i9 || !hashTable.insertAndFindWiderMatch(bArr, match2.end() - 2, match2.start + 1, i10, match2.len, match3)) {
                        i12 = LZ4UnsafeUtils.encodeSequence(bArr, i6, match2.start, match2.ref, match2.len, bArr2, i12, i8);
                        i6 = match2.end();
                        i11 = i6;
                    } else {
                ...
                i12 = LZ4UnsafeUtils.encodeSequence(bArr, match2.end(), match3.start, match3.ref, match3.len, bArr2, LZ4UnsafeUtils.encodeSequence(bArr, i6, match2.start, match2.ref, match2.len, bArr2, i12, i8), i8);
                i6 = match3.end();
                i11 = i6;
            }
        }
        return LZ4UnsafeUtils.lastLiterals(bArr, i6, i7 - i6, bArr2, i12, i8) - i4;
    }
